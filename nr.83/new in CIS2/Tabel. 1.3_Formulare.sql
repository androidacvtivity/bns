...
SELECT  DISTINCT
 ...
 '0' AS NUME_SECTIE2, 
  ...
  RD.ORDINE AS ORDINE,
   ...
   ROUND(SUM(CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN  D.COL13 END),1) AS COL13
FROM
  MD_RIND RD
...
GROUP BY
  ...
  HAVING 
   ...
   ROUND(SUM(CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN  D.COL1 END),1) >0 OR 
   ROUND(SUM(CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN  D.COL2 END),1) >0 OR 
   ROUND(SUM(CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN  D.COL3 END),1) >0 OR   
   ROUND(SUM(CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN  D.COL4 END),1) >0 OR 
   ROUND(SUM(CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN  D.COL5 END),1) >0 OR 
   ROUND(SUM(CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN  D.COL6 END),1) >0 OR 
   ROUND(SUM(CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN  D.COL7 END),1) >0 OR 
   ROUND(SUM(CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN  D.COL8 END),1) >0 OR 
   ROUND(SUM(CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN  D.COL9 END),1) >0 OR 
   ROUND(SUM(CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN  D.COL10 END),1) >0 OR 
   ROUND(SUM(CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN  D.COL11 END),1) >0 OR 
   ROUND(SUM(CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN  D.COL12 END),1) >0 OR 
   ROUND(SUM(CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN  D.COL13 END),1) >0  
