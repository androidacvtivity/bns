...
SELECT  DISTINCT
  ...
  :pCOD_CUATM,
    ...
    CD.NR_ROW AS ORDINE,
    '000000000000000000' AS DECIMAL_POS,  
    CD.NUME_ROW AS NUME_ROW,        
   
    ROUND(SUM  (CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  AND RD.RIND IN ('01')  THEN D.COL1 ELSE NULL END),1) AS COL1,
    ROUND(SUM  (CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  AND RD.RIND IN ('01')  THEN D.COL2 ELSE NULL END),1) AS COL2,
    ROUND(SUM  (CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  AND RD.RIND IN ('02','03')  THEN D.COL1 ELSE NULL END),1) AS COL3,
    ROUND(SUM  (CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  AND RD.RIND IN ('02','03')  THEN D.COL2 ELSE NULL END),1) AS COL4,
    ROUND(SUM  (CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  AND RD.RIND IN ('02')  THEN D.COL1 ELSE NULL END),1) AS COL5,
    ROUND(SUM  (CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  AND RD.RIND IN ('02')  THEN D.COL2 ELSE NULL END),1) AS COL6,
    ROUND(SUM  (CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  AND RD.RIND IN ('03')  THEN D.COL1 ELSE NULL END),1) AS COL7,
    ROUND(SUM  (CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  AND RD.RIND IN ('03')  THEN D.COL2 ELSE NULL END),1) AS COL8,
    ROUND(SUM  (CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  AND RD.RIND IN ('04')  THEN D.COL1 ELSE NULL END),1) AS COL9,
    ROUND(SUM  (CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  AND RD.RIND IN ('04')  THEN D.COL2 ELSE NULL END),1) AS COL10,
    ROUND(SUM  (CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  AND RD.RIND IN ('05')  THEN D.COL1 ELSE NULL END),1) AS COL11,
    ROUND(SUM  (CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  AND RD.RIND IN ('05')  THEN D.COL2 ELSE NULL END),1) AS COL12,
    ROUND(SUM  (CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  AND RD.RIND IN ('06')  THEN D.COL1 ELSE NULL END),1) AS COL13,
    ROUND(SUM  (CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  AND RD.RIND IN ('06')  THEN D.COL2 ELSE NULL END),1) AS COL14,
    ROUND(SUM  (CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  AND RD.RIND IN ('07')  THEN D.COL1 ELSE NULL END),1) AS COL15,
    ROUND(SUM  (CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  AND RD.RIND IN ('07')  THEN D.COL2 ELSE NULL END),1) AS COL16,
    ROUND(SUM  (CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  AND RD.RIND IN ('08')  THEN D.COL1 ELSE NULL END),1) AS COL17,
    ROUND(SUM  (CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  AND RD.RIND IN ('08')  THEN D.COL2 ELSE NULL END),1) AS COL18
...
FROM
  ...
  ( 
    ...
    SELECT 'TDS Nistru' AS NUME_ROW,                              '40' AS NR_ROW, '9800000' AS CUATM FROM DUAL UNION
