...
SELECT
  ...
  REPLACE(REPLACE(REPLACE(MR.DENUMIRE,'<b>',''),'</b>',''),'<br>','') NUME_ROW,
   ...
   ROUND(SUM(CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN  D.COL1 END),1) AS COL1, 
   ROUND(SUM(CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN  D.COL2 END),1) AS COL2,
   ROUND(SUM(CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN  D.COL3 END),1) AS COL3,
   ROUND(SUM(CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN  D.COL4 END),1) AS COL4,
   ROUND(SUM(CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN  D.COL5 END),1) AS COL5,
   ROUND(SUM(CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN  D.COL6 END),1) AS COL6,
   ROUND(SUM(CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN  D.COL7 END),1) AS COL7,
   ROUND(SUM(CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN  D.COL8 END),1) AS COL8,
   ROUND(SUM(CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN  D.COL9 END),1) AS COL9,
   ROUND(SUM(CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN  D.COL10 END),1) AS COL10,
   ROUND(SUM(CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN  D.COL11 END),1) AS COL11,
   ROUND(SUM(CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN  D.COL12 END),1) AS COL12
