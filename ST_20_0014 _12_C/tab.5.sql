...
SELECT 
    ...
    SUM(CASE WHEN D.RIND IN ('110') THEN D.COL1 ELSE NULL END )  AS COL1,
    SUM(CASE WHEN D.RIND IN ('110') THEN D.COL2 ELSE NULL END )  AS COL2,
    SUM(CASE WHEN D.RIND IN ('110') THEN D.COL3 ELSE NULL END )  AS COL3,
    SUM(CASE WHEN D.RIND IN ('110') THEN D.COL4 ELSE NULL END )  AS COL4,
    SUM(CASE WHEN D.RIND IN ('110') THEN D.COL5 ELSE NULL END )  AS COL5,
    SUM(CASE WHEN D.RIND IN ('110') THEN D.COL6 ELSE NULL END )  AS COL6,
    SUM(CASE WHEN D.RIND IN ('110') THEN D.COL7 ELSE NULL END )  AS COL7,
    SUM(CASE WHEN D.RIND IN ('110') THEN D.COL8 ELSE NULL END )  AS COL8,
    SUM(CASE WHEN D.RIND IN ('110') THEN D.COL9 ELSE NULL END )  AS COL9,
    SUM(CASE WHEN D.RIND IN ('110') THEN D.COL10 ELSE NULL END )  AS COL10,
    SUM(CASE WHEN D.RIND IN ('110') THEN D.COL11 ELSE NULL END )  AS COL11
  ...
  D.FORM = 55  AND D.CAPITOL IN (1080)
