...
SELECT
  ...
  CIS2.NVAL(SUM(CASE WHEN CAPITOL IN (1038) AND D.RIND NOT IN '0000000' THEN COL1 ELSE 0 END)) AS COL1,
  CIS2.NVAL(SUM(CASE WHEN CAPITOL IN (1038) AND D.RIND NOT IN '0000000' THEN COL2 ELSE 0 END)) AS COL2,
  CIS2.NVAL(SUM(CASE WHEN CAPITOL IN (1038) AND D.RIND NOT IN '0000000' THEN COL3 ELSE 0 END)) AS COL3,
  CIS2.NVAL(SUM(CASE WHEN CAPITOL IN (1038) AND D.RIND NOT IN '0000000' THEN COL4 ELSE 0 END)) AS COL4,
  CIS2.NVAL(SUM(CASE WHEN CAPITOL IN (1038) AND D.RIND NOT IN '0000000' THEN COL5 ELSE 0 END)) AS COL5,
  CIS2.NVAL(SUM(CASE WHEN CAPITOL IN (1038) AND D.RIND NOT IN '0000000' THEN COL6 ELSE 0 END)) AS COL6,
  CIS2.NVAL(SUM(CASE WHEN CAPITOL IN (1038) AND D.RIND NOT IN '0000000' THEN COL7 ELSE 0 END)) AS COL7
...
WHERE
  ...
  (:pID_MDTABLE=:pID_MDTABLE) AND
   D.FORM = 47 AND
  -- D.CUIIO=3399698 AND
   D.CAPITOL IN (1038) AND CC.PRGS NOT IN 4  AND
