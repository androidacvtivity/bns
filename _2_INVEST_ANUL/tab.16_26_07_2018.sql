...
--               '0' AS NUME_SECTIE2, 
        ...
        SELECT
                ...
                SUM(CASE WHEN  RD.RIND =  MR.RIND THEN CIS2.NVAL(D.COL1) + CIS2.NVAL(D.COL2)  ELSE NULL END) AS COL1,
               -----------------------------------------------------------
               
               ROUND(SUM(CASE WHEN  RD.RIND =  MR.RIND THEN CIS2.NVAL(D.COL1) + CIS2.NVAL(D.COL2)  ELSE NULL END) /
                
               CIS2.NOZERO(SUM(CASE WHEN   RD.RIND =  MR.RIND THEN CIS2.NVAL(D.COL3) + CIS2.NVAL(D.COL4)  ELSE NULL END)),1) AS COL2,
               
              --------------------------------------
              
              CASE WHEN RD.RIND IN '100' THEN 100 ELSE  
              
              (SUM(CASE WHEN   RD.RIND =  MR.RIND THEN CIS2.NVAL(D.COL1) + CIS2.NVAL(D.COL2)  ELSE NULL END) * 100)  /
              
              
              
              SUM(CASE WHEN  MR.RIND IN ('100') THEN CIS2.NVAL(D.COL3) + CIS2.NVAL(D.COL4)  ELSE NULL END) 
               ...
               FROM CIS2.DATA_ALL D
                    ...
                    INNER JOIN CIS2.VW_CL_CFP CC ON CF.FULL_CODE LIKE '%'||CC.CODUL||';%'
                      ---------------------------------------------------------
