...
FROM (
            ...
            -----------------------------------------------------------------------------------------------------------------------------
             ROUND(((SUM(CASE WHEN MR.RIND = R.RIND  AND RR.CFP IN (12,13) THEN CIS2.NVAL(D.COL1)+CIS2.NVAL(D.COL2) ELSE 0 END)  /
             CIS2.NOZERO(SUM(CASE WHEN MR.RIND = R.RIND  AND RR.CFP IN (12,13) THEN CIS2.NVAL(D.COL3)+CIS2.NVAL(D.COL4) ELSE 0 END))) / P.COL1) * 100,1) AS COL3,
    ...
    WHERE
     ...
     AND RIND NOT IN ('410','420','430','441','442','450','440')
          ...
          SELECT 
           ...
           D.FORM = 8 AND
           MR.CAPITOL = 323
           AND MR.RIND NOT IN ('410','420','430','441','442','450','440')
