...
(
 ...
 COL1, COL2, COL3,COL4,COL5,COL6,COL7,COL8,COL9,COL10, COL11
            ...
            SELECT 
             ...
             ---------------------------------------------------------------------------------------------------------------------------
             SUM(CASE WHEN MR.RIND = R.RIND  THEN CIS2.NVAL(D.COL1)+CIS2.NVAL(D.COL2) ELSE 0 END) AS COL1,
             -----------------------------------------------------------------------------------------------------------------------
             SUM(CASE WHEN MR.RIND = R.RIND  AND RR.CFP IN (12,13) THEN CIS2.NVAL(D.COL1)+CIS2.NVAL(D.COL2) ELSE NULL END) AS COL2,
            -----------------------------------------------------------------------------------------------------------------------------
             ((SUM(CASE WHEN MR.RIND = R.RIND  AND RR.CFP IN (12,13) THEN CIS2.NVAL(D.COL1)+CIS2.NVAL(D.COL2) ELSE 0 END)  /
             CIS2.NOZERO(SUM(CASE WHEN MR.RIND = R.RIND  AND RR.CFP IN (12,13) THEN CIS2.NVAL(D.COL3)+CIS2.NVAL(D.COL4) ELSE 0 END))) ) AS COL3,
            ...
            -----------------------------------------------------------------------------------------------------------------------------
             ...
             ((SUM(CASE WHEN MR.RIND = R.RIND  AND RR.CFP IN (15,16,17,18,19) THEN CIS2.NVAL(D.COL1)+CIS2.NVAL(D.COL2) ELSE 0 END)  /
             CIS2.NOZERO(SUM(CASE WHEN MR.RIND = R.RIND  AND RR.CFP IN (15,16,17,18,19) THEN CIS2.NVAL(D.COL3)+CIS2.NVAL(D.COL4) ELSE 0 END))) ) AS COL5,
             ...
             ((SUM(CASE WHEN MR.RIND = R.RIND  AND RR.CFP IN (20) THEN CIS2.NVAL(D.COL1)+CIS2.NVAL(D.COL2) ELSE 0 END)  /
             CIS2.NOZERO(SUM(CASE WHEN MR.RIND = R.RIND  AND RR.CFP IN (20) THEN CIS2.NVAL(D.COL3)+CIS2.NVAL(D.COL4) ELSE 0 END))) ) AS COL7,
             -----------------------------------------------
             ...
             ((SUM(CASE WHEN MR.RIND = R.RIND  AND RR.CFP IN (24,26)  THEN CIS2.NVAL(D.COL1)+CIS2.NVAL(D.COL2) ELSE 0 END)  /
             CIS2.NOZERO(SUM(CASE WHEN MR.RIND = R.RIND  AND RR.CFP IN (24,26)  THEN CIS2.NVAL(D.COL3)+CIS2.NVAL(D.COL4) ELSE 0 END))) ) AS COL9,
             --------------------------------------------------------------------------------------------------------------------------
             
             SUM(CASE WHEN MR.RIND = R.RIND  AND RR.CFP IN (28) THEN CIS2.NVAL(D.COL1)+CIS2.NVAL(D.COL2) ELSE NULL END) AS COL10,
             -----------------------------------------------------------------------------------------
             ((SUM(CASE WHEN MR.RIND = R.RIND  AND RR.CFP IN (28)  THEN CIS2.NVAL(D.COL1)+CIS2.NVAL(D.COL2) ELSE 0 END)  /
             CIS2.NOZERO(SUM(CASE WHEN MR.RIND = R.RIND  AND RR.CFP IN (28)  THEN CIS2.NVAL(D.COL3)+CIS2.NVAL(D.COL4) ELSE 0 END))) )  AS COL11
             --------------------------------------------------------------------------------------------------------------------------
