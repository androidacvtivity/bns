...
--               '0' AS NUME_SECTIE2,
               ...
               END AS COL9  
                ...
                SUM(CASE WHEN D.PERIOADA IN (:pPERIOADA - 1)  AND R.RIND =  MR.RIND THEN CIS2.NVAL(D.COL1) + CIS2.NVAL(D.COL2)   ELSE NULL END) AS COL4,
                SUM(CASE WHEN D.PERIOADA IN (:pPERIOADA - 1)  AND R.RIND =  MR.RIND THEN CIS2.NVAL(D.COL1)  ELSE NULL END) AS COL5,
                SUM(CASE WHEN D.PERIOADA IN (:pPERIOADA - 1)  AND R.RIND =  MR.RIND THEN CIS2.NVAL(D.COL2)  ELSE NULL END) AS COL6,
                      
               ((SUM(CASE WHEN D.PERIOADA IN (:pPERIOADA) AND  R.RIND =  MR.RIND THEN CIS2.NVAL(D.COL1) + CIS2.NVAL(D.COL2)  ELSE NULL END)  /
               CIS2.NOZERO(SUM(CASE WHEN D.PERIOADA IN (:pPERIOADA - 1)    AND R.RIND =  MR.RIND THEN CIS2.NVAL(D.COL1) + CIS2.NVAL(D.COL2) ELSE NULL END))) )   AS COL7,
               
               ((SUM(CASE WHEN D.PERIOADA IN (:pPERIOADA) AND  R.RIND =  MR.RIND THEN CIS2.NVAL(D.COL1)  ELSE NULL END)  /
               CIS2.NOZERO(SUM(CASE WHEN D.PERIOADA IN (:pPERIOADA - 1)  AND R.RIND =  MR.RIND THEN CIS2.NVAL(D.COL1)  ELSE NULL END))) )   AS COL8,
               
                ((SUM(CASE WHEN D.PERIOADA IN (:pPERIOADA) AND   R.RIND =  MR.RIND THEN CIS2.NVAL(D.COL2)  ELSE NULL END)  /
               CIS2.NOZERO(SUM(CASE WHEN D.PERIOADA IN (:pPERIOADA - 1)  AND R.RIND =  MR.RIND THEN CIS2.NVAL(D.COL2)  ELSE NULL END))) )   AS COL9
