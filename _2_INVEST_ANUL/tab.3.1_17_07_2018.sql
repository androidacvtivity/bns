...
FROM (
   ...
   SUM(CASE WHEN R.RIND = D.RIND  THEN D.COL1 ELSE NULL END)AS COL1,
...
SELECT
  ...
  SUM( CASE WHEN R.RIND = D.RIND AND D.RIND IN ('440')  THEN D.COL1 ELSE NULL END)AS COL1,
  ...
  ROUND(((SUM(CASE WHEN R.RIND = D.RIND  THEN D.COL1 ELSE 0 END))*100)/  
         CIS2.NOZERO((SUM(CASE WHEN D.RIND IN '100' THEN D.COL1 ELSE 0 END))),1) AS COL3
