...
--)
             ...
             SELECT 
               ...
               END AS COL7  
                ...
                SUM(CASE WHEN B.CFP LIKE '%'|| RR.CFP ||'%' AND R.RIND =  MR.RIND THEN  D.COL1   ELSE NULL END) AS COL2,
                SUM(CASE WHEN B.CFP LIKE '%'|| RR.CFP ||'%' AND R.RIND =  MR.RIND THEN  D.COL2   ELSE NULL END) AS COL3,
                SUM(CASE WHEN B.CFP LIKE '%'|| RR.CFP ||'%' AND R.RIND =  MR.RIND THEN CIS2.NVAL(D.COL3) + CIS2.NVAL(D.COL4)  ELSE NULL END) AS COL4,
                SUM(CASE WHEN B.CFP LIKE '%'|| RR.CFP ||'%' AND R.RIND =  MR.RIND THEN  D.COL3   ELSE NULL END) AS COL5,
                SUM(CASE WHEN B.CFP LIKE '%'|| RR.CFP ||'%' AND R.RIND =  MR.RIND THEN  D.COL4   ELSE NULL END) AS COL6,
                      
               ((SUM(CASE WHEN B.CFP LIKE '%'|| RR.CFP ||'%' AND R.RIND =  MR.RIND THEN CIS2.NVAL(D.COL1) + CIS2.NVAL(D.COL2)  ELSE NULL END)  /
               CIS2.NOZERO(SUM(CASE WHEN B.CFP LIKE '%'|| RR.CFP ||'%' AND R.RIND =  MR.RIND THEN CIS2.NVAL(D.COL3) + CIS2.NVAL(D.COL4)  ELSE NULL END))) )   AS COL7
