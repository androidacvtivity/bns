CREATE OR REPLACE FORCE VIEW USER_BANCU.VW_REGISTRU_MODIF
(
   IDNO,
   DATA_REG,
   DEN_COM,
...
SELECT 
          ...
          DATA_REG,
           ...
           CASE 
            ...
            THEN  REPLACE(DEN_COM,'Societatea cu Raspundere Limitata','SRL')  
            
            WHEN   DEN_COM LIKE '%GOSPODARIA TARANEASCA%'
           
            THEN  REPLACE(DEN_COM,'GOSPODARIA TARANEASCA','GŢ')
          ...
          --------------------------------------------------------------------
            ...
            THEN  REPLACE(DEN_COM,'GOSPODARIE TARANEASCA','GŢ')
            
            ---------------------------------------------------------------------
            WHEN   DEN_COM LIKE '%COOPERATIVA AGRICOLA DE PRODUCTIE%'
           
            THEN  REPLACE(DEN_COM,'COOPERATIVA AGRICOLA DE PRODUCTIE','CAP')
            
            ----------------------------------------------------------------
            WHEN   DEN_COM LIKE '%SOCIETATEA PE ACTIUNI%'
           
            THEN  REPLACE(DEN_COM,'SOCIETATEA PE ACTIUNI','SA')
            ----------------------------------------------------------------
            
              ----------------------------------------------------------------
            WHEN   DEN_COM LIKE '%SOCIETATEA COMERCIALA%'
           
            THEN  REPLACE(DEN_COM,'SOCIETATEA COMERCIALA','SC')
            ----------------------------------------------------------------
            ...
            THEN  REPLACE(DEN_COM,'INTREPRINDEREA INDIVIDUALA','II')
            ----------------------------------------------------------------
             ----------------------------------------------------------------
            WHEN   DEN_COM LIKE '%Intreprinderea Individuala%'
            ...
            THEN  REPLACE(DEN_COM,'Intreprinderea Mixta','IM')
            ----------------------------------------------------------------
            ...
            THEN  REPLACE(DEN_COM,'SOCIETATE COMERCIALA','SC')
            ----------------------------------------------------------------
            ...
            THEN  REPLACE(DEN_COM,'Societatea cu Răspundere Limitată','SRL')
            ...
            THEN  REPLACE(DEN_COM,'SOCITATE CU RESPONSIBILITATE LIMITATA','SRL')
            ...
            THEN  REPLACE(DEN_COM,'SOCIETATEA CU RASPUNDRE LIMITATA','SRL')
            ...
            THEN  REPLACE(DEN_COM,'SOCIETATII CU RASPUNDEREA LIMITATA','SRL')
            ...
            THEN  REPLACE(DEN_COM,'SOCIETATE CU RASPUNDERE LIMITATA','SRL')
            ...
            THEN  REPLACE(DEN_COM,'SOCIETATEA CU RESPONSABILITATE LIMITATA','SRL')
            ...
            THEN  REPLACE(DEN_COM,'SOCIETATEA CU RESPUNDERE LIMITATA','SRL')
            ...
            THEN  REPLACE(DEN_COM,'SOCIETATE CU RESPONSADILITATE LIMITATA','SRL')
            
            ---------------------------------------------------------
            
             WHEN   DEN_COM LIKE '%SOCIETATEA CU RASPUNDEREA LIMITATA%'
           
            THEN  REPLACE(DEN_COM,'SOCIETATEA CU RASPUNDEREA LIMITATA','SRL')
            
            ---------------------------------------------------------
            
            WHEN   DEN_COM LIKE '%SOCIETATEA CU RĂSRUNDERE LIMITATĂ%'
           
            THEN  REPLACE(DEN_COM,'SOCIETATEA CU RĂSRUNDERE LIMITATĂ','SRL')
            ...
            THEN  REPLACE(DEN_COM,'SOCIETATEA CU RĂPUNDERE LIMITATĂ','SRL')
            ----------------------------------------------------------
            WHEN   DEN_COM LIKE '%ЯSOCIETATEA RESPONSABILITATE LIMITATA%'
           
            THEN  REPLACE(DEN_COM,'ЯSOCIETATEA RESPONSABILITATE LIMITATA','SRL')
            
            --
            WHEN   DEN_COM LIKE '%SOCIETATEA COMERCIALĂ%'
           
            THEN  REPLACE(DEN_COM,'SOCIETATEA COMERCIALĂ','SC')
            ...
            THEN  REPLACE(DEN_COM,'Societatea cu Responsabilitate Limitată','SC')
            ...
            THEN  REPLACE(DEN_COM,'SOCIETTE CU RASPUNDERE LIMITATA','SRL')
            ...
            THEN  REPLACE(DEN_COM,'SOCIETETEA CU RASPUNDERE LIMITATA','SRL')
            
            ---------------------------------------------------------
            
            WHEN   DEN_COM LIKE '%SOCIETETA CU RASPUNDERE LIMITATA%'
           
            THEN  REPLACE(DEN_COM,'SOCIETETA CU RASPUNDERE LIMITATA','SRL')
            ...
            THEN  REPLACE(DEN_COM,'SOCIETEA CU RASPUNDERE LUMUTATA','SRL')
            ...
            THEN  REPLACE(DEN_COM,'SOCIETEA CU RASPUNDERE LIMITATA','SRL')
            ...
            THEN  REPLACE(DEN_COM,'SOCIETATII CU RESPUNDERE LIMITATA','SRL')
            ...
            THEN  REPLACE(DEN_COM,'SOCIETATII CU RESPOSABILITATE','SRL')
            
            ---------------------------------------------------------           
            --3
            WHEN   DEN_COM LIKE '%SOCIETATII CU RESPONSABILITATE LIMITATA%'
           
            THEN  REPLACE(DEN_COM,'SOCIETATII CU RESPONSABILITATE LIMITATA','SRL')
            ...
            THEN  REPLACE(DEN_COM,'SOCIETATЕ CU RASPUNDERE LIMITATA','SRL')
            
            ---------------------------------------------------------     
            --2
            WHEN   DEN_COM LIKE '%SOCIETATYEA CU RASPUNDERE LIMITATA%'
           
            THEN  REPLACE(DEN_COM,'SOCIETATYEA CU RASPUNDERE LIMITATA','SRL')
            ...
            THEN  REPLACE(DEN_COM,'SOCIETATII CU RESPONSABILITATE LIMITAT','SRL')
          ...
          ---------------------------------------------------------     
            ...
            THEN  REPLACE(DEN_COM,'SOCIETATII CU RESPENSABILITATE LIMITATA','SRL')
            
            ---------------------------------------------------------  
           --3
            WHEN   DEN_COM LIKE '%SOCIETATII CU RASPUNDERER LIMITATA%'
           
            THEN  REPLACE(DEN_COM,'SOCIETATII CU RASPUNDERER LIMITATA','SRL')
           ...
           --4
            ...
            THEN  REPLACE(DEN_COM,'SOCIETATII CU RASPUNDERE LIMITATA','SRL')
           ...
           --1
            ...
            THEN  REPLACE(DEN_COM,'SOCIETATIA CU RESPONSABILITATE LIMITATA','SRL')
           ...
           --2
            ...
            THEN  REPLACE(DEN_COM,'SOCIETATIA CU RASPUNDERE LIMITATA','SRL')
           ...
           --1
            ...
            THEN  REPLACE(DEN_COM,'SOCIETATEА CU RELATII LIMITATE','SRL')
           ...
           --2
            ...
            THEN  REPLACE(DEN_COM,'SOCIETATEА CU RASРUNDERE LIMITATA','SRL')
  ...
  --------------------------------------------------------------------------------
            ...
            CASE WHEN   FORMA_ORG LIKE '%Societate cu răspundere limitată%'
           
            THEN  REPLACE(FORMA_ORG,'Societate cu răspundere limitată','SRL')
