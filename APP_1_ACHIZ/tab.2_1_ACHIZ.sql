...
SELECT 
  ...
  D.RIND_VERS,
    ...
    ROUND(SUM(CASE WHEN CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%'  THEN CIS2.NVAL(D.COL1) + CIS2.NVAL(D.COL3) END ),2)  AS COL1,
    ROUND(SUM(CASE WHEN CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%'  THEN CIS2.NVAL(D.COL4) + CIS2.NVAL(D.COL2) END ),2)  AS COL2,
    ROUND(SUM(CASE WHEN CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%'  THEN CIS2.NVAL(D.COL4) + CIS2.NVAL(D.COL2) END )  /  CIS2.NOZERO(SUM(CASE WHEN CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%'  THEN CIS2.NVAL(D.COL1) + CIS2.NVAL(D.COL3) END )),2) AS COL3,
    
  
    
    
    ROUND(SUM(CASE WHEN CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' THEN CIS2.NVAL(D.COL1)  END ),2)  AS COL4,
    ROUND(SUM(CASE WHEN CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' THEN CIS2.NVAL(D.COL2)  END ),2)  AS COL5, 
    
    
    ROUND(SUM(CASE WHEN CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%'  THEN CIS2.NVAL(D.COL2)  END )  /  CIS2.NOZERO(SUM(CASE WHEN CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%'  THEN CIS2.NVAL(D.COL1) END )),2) AS COL6,
    
    
    ROUND(SUM(CASE WHEN CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%'  THEN CIS2.NVAL(D.COL3) END ),2)  AS COL7,
    ROUND(SUM(CASE WHEN CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%'  THEN CIS2.NVAL(D.COL4) END ),2) AS COL8, 
    
   ROUND(SUM(CASE WHEN CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%'  THEN CIS2.NVAL(D.COL4)  END )  /  CIS2.NOZERO(SUM(CASE WHEN CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%'  THEN CIS2.NVAL(D.COL3) END )),2) AS COL9,  
