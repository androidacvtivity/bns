...
SELECT
  ...
  '0' AS NR_SECTIE2,
  '0' AS NUME_SECTIE2,
  SUM(CASE WHEN CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%'  THEN NVAL(D.COL1) + NVAL(D.COL3) END )  ||'~'||R.NR_ROW  AS NR_ROW,
  R.NR_ROW AS ORDINE,
 '000000000' AS DECIMAL_POS, 
  R.NUME_ROW,

    SUM(CASE WHEN CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%'  THEN NVAL(D.COL1) ELSE NULL  END)  AS COL1,
    SUM(CASE WHEN CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%'  THEN NVAL(D.COL2) ELSE NULL END)  AS COL2,
    SUM(CASE WHEN CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%'  THEN NVAL(D.COL4)+NVAL(D.COL5)+NVAL(D.COL6) ELSE NULL END)  AS COL3,
    SUM(CASE WHEN CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%'  THEN NVAL(D.COL4) ELSE NULL END)  AS COL4,
    SUM(CASE WHEN CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%'  THEN NVAL(D.COL5) ELSE NULL END)  AS COL5,
    SUM(CASE WHEN CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%'  THEN NVAL(D.COL6) ELSE NULL END)  AS COL6,
    SUM(CASE WHEN CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%'  THEN NVAL(D.COL7) ELSE NULL END)  AS COL7,
    SUM(CASE WHEN CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%'  THEN NVAL(D.COL8) ELSE NULL END)  AS COL8,
    SUM(CASE WHEN CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%'  THEN NVAL(D.COL9) ELSE NULL END)  AS COL9
