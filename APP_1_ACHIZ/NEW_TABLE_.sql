...
SELECT 
  ...
  ROUND((CIS2.NVAL(COL2)/CIS2.NOZERO(COL1)*1000),2) AS COL2
FROM 
(
SELECT 
  R.NR_ROW AS ORDINE,
  R.NUME_ROW AS NUME_ROW,
  CIS2.NVAL(SUM(CASE WHEN CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' THEN D.COL1 ELSE 0 END)) AS COL1,
  CIS2.NVAL(SUM(CASE WHEN CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' THEN D.COL2 ELSE 0 END)) AS COL2
FROM 
  CIS2.VW_DATA_ALL D
