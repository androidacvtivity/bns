SELECT  
    ...
    '0' AS NUME_SECTIE2,
     ...
     SUM(CASE WHEN D.RIND = VBG.RIND THEN D.COL1 ELSE NULL END) ||'~'||VBG.RIND AS NR_ROW, 
     VBG.RIND ORDINE,
    '0000000000' AS DECIMAL_POS,
     REPLACE(VBG.DENUMIRE, '<br>') NUME_ROW,
     SUM(CASE WHEN D.RIND = VBG.RIND THEN D.COL3 ELSE NULL END) AS COL1,   
     SUM(CASE WHEN D.RIND = VBG.RIND THEN D.COL4 ELSE NULL END ) AS COL2, 
     SUM(CASE WHEN D.RIND = VBG.RIND THEN D.COL6 ELSE NULL END ) AS COL3, 
     SUM(CASE WHEN D.RIND = VBG.RIND THEN D.COL7 ELSE NULL END ) AS COL4, 
     SUM(CASE WHEN D.RIND = VBG.RIND THEN D.COL9 ELSE NULL END ) AS COL5, 
     SUM(CASE WHEN D.RIND = VBG.RIND THEN D.COL11 ELSE NULL END ) AS COL6, 
     SUM(CASE WHEN D.RIND = VBG.RIND THEN D.COL13 ELSE NULL END ) AS COL7, 
     SUM(CASE WHEN D.RIND = VBG.RIND THEN D.COL15 ELSE NULL END ) AS COL8, 
     SUM(CASE WHEN D.RIND = VBG.RIND THEN D.COL16 ELSE NULL END ) AS COL9 
