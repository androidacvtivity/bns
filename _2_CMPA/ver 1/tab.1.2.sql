...
SELECT 
    ...
    '0' AS NR_SECTIE2,
     '0' AS NUME_SECTIE2,
         ...
         SUM(CASE WHEN  MR.RIND = R.RIND     THEN  D.COL14  ELSE NULL END) AS COL14,
         SUM(CASE WHEN  MR.RIND = R.RIND     THEN  D.COL15  ELSE NULL END) AS COL15,
         SUM(CASE WHEN  MR.RIND = R.RIND     THEN  D.COL16  ELSE NULL END) AS COL16,
         SUM(CASE WHEN  MR.RIND = R.RIND     THEN  D.COL17  ELSE NULL END) AS COL17,
         SUM(CASE WHEN  MR.RIND = R.RIND     THEN  D.COL18  ELSE NULL END) AS COL18,
         SUM(CASE WHEN  MR.RIND = R.RIND     THEN  D.COL19  ELSE NULL END) AS COL19
