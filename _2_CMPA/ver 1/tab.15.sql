SELECT 
    ...
    '0' AS NUME_SECTIE2,
          ...
          CTT.CODUL,
          CTT.DENUMIRE,
          SUM(CASE WHEN  MR.RIND IN ('200') THEN  D.COL2 ELSE NULL END  ) AS COL1,
          
          SUM(CASE WHEN  MR.RIND IN ('201') THEN  D.COL2 ELSE NULL END  ) AS COL2,
          
           ROUND(SUM(CASE WHEN  MR.RIND IN ('201') THEN  D.COL2 ELSE NULL  END ) /  
          NOZERO(SUM(CASE WHEN  MR.RIND IN ('200') THEN  D.COL2 ELSE NULL END )),1)  AS COL3
