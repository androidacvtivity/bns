SELECT  
    ...
    '0' AS NUME_SECTIE2,
     ...
     SUM(CASE WHEN D.RIND = VBG.RIND AND  MP.NUM = 1   THEN D.COL1 ELSE NULL END) ||'~'||VBG.RIND AS NR_ROW, 
     VBG.RIND ORDINE,
    '000000000' AS DECIMAL_POS,
     ...
     SUM(CASE WHEN D.RIND = VBG.RIND AND MP.NUM = 1  THEN D.COL16 ELSE NULL END ) AS COL9 
