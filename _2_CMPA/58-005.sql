...
DECODE(CC.NR_COLUMN, '1', 'COL1 ', '2', 'COL2 ', '3', 'COL3 ', '4', 'COL4 ', '5', 'COL5 ' , '6', 'COL6 ' , '7', 'COL7 ' , '8', 'COL8 ' , '9', 'COL9 ' , '10', 'COL10 ' , '11', 'COL11 ' , '12', 'COL12 '  , '13', 'COL13 ' , '14', 'COL14 ' , '15', 'COL15 ' , '16', 'COL16 ' , '17', 'COL17 ' , '18', 'COL18 ' , '19', 'COL19 ')||': '|| 
  NVAL(SUM(CASE WHEN D.RIND IN ('020') THEN DECODE(CC.NR_COLUMN, '1', D.COL1, '2', D.COL2, '3', D.COL3, '4', D.COL4, '5', D.COL5 , '6', D.COL6 , '7', D.COL7 , '8', D.COL8 , '9', D.COL9 , '10', D.COL10 , '11', D.COL11 , '12', D.COL12 , '13', D.COL13 , '14', D.COL14 ,'15', D.COL15 , '16', D.COL16 , '17', D.COL17 , '18', D.COL18 , '19', D.COL19) END)) ||' <> '||
  NVAL(SUM(CASE WHEN D.RIND IN ('021','022','023') THEN DECODE(CC.NR_COLUMN, '1', D.COL1, '2', D.COL2, '3', D.COL3, '4', D.COL4, '5', D.COL5 , '6', D.COL6 , '7', D.COL7 , '8', D.COL8 , '9', D.COL9 , '10', D.COL10 , '11', D.COL11 , '12', D.COL12 , '13', D.COL13 , '14', D.COL14 ,'15', D.COL15 , '16', D.COL16 , '17', D.COL17 , '18', D.COL18 , '19', D.COL19) END))
  AS REZULTAT
