...
DECODE(CC.NR_COLUMN, '1', 'COL1 ', '2', 'COL2 ', '3', 'COL3 ', '4', 'COL4 ', '5', 'COL5 ' , '6', 'COL6 ' , '7', 'COL7 ' , '8', 'COL8 ' , '9', 'COL9 ' , '10', 'COL10 ' , '11', 'COL11 ' , '12', 'COL12 '  , '13', 'COL13 ' , '14', 'COL14 ' , '15', 'COL15 ' , '16', 'COL16 ' , '17', 'COL17 ' , '18', 'COL18 ' , '19', 'COL19 ')||': '|| 
 'CAP. I Rind 031 = '|| NVAL(SUM(CASE WHEN D.CAPITOL IN (416)   AND D.RIND IN ('031') THEN DECODE(CC.NR_COLUMN,  '4', D.COL4,  '6', D.COL6 , '7', D.COL7 , '9', D.COL9 , '13', D.COL13 ,  '16', D.COL16 ) END)) ||' CAP II , Rind 031 COL1 =  '||
 NVAL(SUM(CASE WHEN D.CAPITOL IN (417)   AND D.RIND IN ('031') THEN DECODE(CC.NR_COLUMN, '1', D.COL1) END))
  AS REZULTAT
...
WHERE
  ...
  ( (D.FORM IN (58)  AND  D.CAPITOL IN (417)   AND D.RIND IN ('031')) 
   OR  
  (D.FORM IN (58)  AND  D.CAPITOL IN (416)   AND D.RIND IN ('031')))
...
HAVING
NVAL(SUM(CASE WHEN D.CAPITOL IN (416)   AND D.RIND IN ('031') THEN DECODE(CC.NR_COLUMN,  '4', D.COL4,  '6', D.COL6 , '7', D.COL7 , '9', D.COL9 , '13', D.COL13 ,  '16', D.COL16 ) END)) > 0
   
AND 

NVAL(SUM(CASE WHEN D.CAPITOL IN (417)   AND D.RIND IN ('031') THEN D.COL1 ELSE NULL  END)) = 0 