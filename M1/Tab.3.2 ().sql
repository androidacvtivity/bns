...
WHERE
    T.ID_MDTABLE IN (CASE WHEN T.PERIOADA <= 425 THEN 2034 ELSE 2141 END) AND
    --T.ID_MDTABLE IN (2141) AND --TABLE 1.2 *
...
LEFT JOIN (
   ...
   FROM
     TABLE_OUT T
   WHERE
    T.ID_MDTABLE IN (CASE WHEN T.PERIOADA <= 425 THEN 2047 ELSE TO_NUMBER(:pID_MDTABLE) END) AND
