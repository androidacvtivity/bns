...
(
  ...
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('750') 
  AND D.CAPITOL IN (1187) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL1, 
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('761','762','763','764','765','766','767','768') AND D.CAPITOL IN (1187) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL2, 
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('761') AND D.CAPITOL IN (1187) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL3, 
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('762') AND D.CAPITOL IN (1187) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL4,
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('763') AND D.CAPITOL IN (1187) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL5,
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('764') AND D.CAPITOL IN (1187) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL6,
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('765') AND D.CAPITOL IN (1187) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL7,
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('766') AND D.CAPITOL IN (1187) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL8,
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('767') AND D.CAPITOL IN (1187) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL9,
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('768') AND D.CAPITOL IN (1187) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL10,
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('770') AND D.CAPITOL IN (1187) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL11
