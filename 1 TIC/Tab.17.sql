...
(
  ...
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('931','932','933','941','951','961','971') 
  AND D.CAPITOL IN (1205) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL1, 
  
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('931') AND D.CAPITOL IN (1205) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL2, 
  
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('932') AND D.CAPITOL IN (1205) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL3, 
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('933') AND D.CAPITOL IN (1205) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL4,
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('941') AND D.CAPITOL IN (1205) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL5,
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('951') AND D.CAPITOL IN (1205) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL6,
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('961') AND D.CAPITOL IN (1205) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL7,
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('971') AND D.CAPITOL IN (1205) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL8
