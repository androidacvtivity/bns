...
(
  ...
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('710') AND D.CAPITOL IN (1187) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL1, 
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('721','722') 
  AND D.CAPITOL IN (1187) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL2, 
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('721') AND D.CAPITOL IN (1187) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL3, 
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('722') AND D.CAPITOL IN (1187) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL4,
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('730') AND D.CAPITOL IN (1187) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL5,
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('740') AND D.CAPITOL IN (1187) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL6
