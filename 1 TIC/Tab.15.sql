...
(
  ...
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('810') 
  AND D.CAPITOL IN (1204) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL1, 
  
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('821','822') AND D.CAPITOL IN (1204) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL2, 
  
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('821') AND D.CAPITOL IN (1204) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL3, 
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('822') AND D.CAPITOL IN (1204) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL4,
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('830') AND D.CAPITOL IN (1204) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL5,
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('840') AND D.CAPITOL IN (1204) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL6,
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('851') AND D.CAPITOL IN (1204) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL7,
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('852') AND D.CAPITOL IN (1204) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL8
