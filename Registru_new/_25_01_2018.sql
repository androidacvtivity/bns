...
DROP TABLE USER_BANCU.REGISTRU_MD_19_12_2017 CASCADE CONSTRAINTS;
...
AS
   SELECT TRIM (VB.IDNO) AS IDNO,
     ...
     FROM USER_BANCU.REGISTRU_MD_19_01_2018 VB;
...
CREATE TABLE USER_BANCU.REGISTRU_MD_19_01_2018
(
  IDNO            NUMBER,
  DATA_REG        DATE,
