DROP VIEW ALL_APP.VW_REG_MODIF_08_04_2019;

/* Formatted on 26/04/2019 11:46:25 (QP5 v5.252.13127.32867) */
CREATE OR REPLACE FORCE VIEW ALL_APP.VW_REG_MODIF_08_04_2019
(
   IDNO,
   DATA_REG,
   DEN_COM,
...
AS
     SELECT IDNO,
            ...
            CASE
               ...
               WHEN DEN_COM LIKE '%Întreprindere individuală%'
               THEN
                  REPLACE (DEN_COM, 'Întreprindere individuală', 'II')
       ...
       FROM (SELECT VB.IDNO,
               ...
               FROM (SELECT TRIM (VB.IDNO) AS IDNO,
                       ...
                       FROM ALL_APP.REGISTRU_MD_08_04_2019 VB --ORDER BY VB.DATA_REG DESC
                                                             ) VB)
      WHERE 1 = 1
   --      --
   --
...
GRANT DELETE, INSERT, UPDATE ON ALL_APP.VW_REG_MODIF_08_04_2019 TO BACKUP;
