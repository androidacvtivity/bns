...
--            DENUMIRE 
      ...
      --  
       ...
       AND DENUMIRE    LIKE '%Societatea cu Raspundere Limitata%'
      
       AND DENUMIRE    LIKE '%SOCIETATEA CU RASPUNDERE LIMITATA%'
        
       AND DENUMIRE    LIKE '%GOSPODARIA TARANEASCA%'
       
       AND DENUMIRE    LIKE '%GOSPODARIE TARANEASCA%'
       
       AND DENUMIRE     LIKE '%COOPERATIVA AGRICOLA DE PRODUCTIE%'
       
       AND DENUMIRE     LIKE '%SOCIETATEA PE ACTIUNI%'
       
       AND DENUMIRE      LIKE '%SOCIETATEA COMERCIALA%'
       
       AND DENUMIRE      LIKE '%INTREPRINDEREA INDIVIDUALA%'
       
       AND DENUMIRE        LIKE '%Intreprinderea Individuala%'
       
       AND DENUMIRE        LIKE '%Intreprinderea Mixta%'
       
       AND DENUMIRE       LIKE '%INTREPRINDEREA MIXTA%'
       
       AND DENUMIRE        LIKE '%SOCIETATE COMERCIALA%'
