...
SELECT 
  ...
  '0' AS NUME_SECTIE2,
   ...
   '00000000000' AS DECIMAL_POS, 
    ...
    SUM(CASE WHEN CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' THEN D.COL1 ELSE NULL END)  AS COL1,
    SUM(CASE WHEN CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' THEN D.COL2 ELSE NULL END )  AS COL2,
    SUM(CASE WHEN CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' THEN  CIS2.NVAL(D.COL4)+ CIS2.NVAL(D.COL5) + CIS2.NVAL(D.COL6) ELSE NULL END  )  AS COL3, 
    SUM(CASE WHEN CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' THEN  D.COL4 ELSE NULL END )  AS COL4,
    SUM(CASE WHEN CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' THEN  D.COL5 ELSE NULL END )  AS COL5,
    SUM(CASE WHEN CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' THEN  D.COL6 ELSE NULL END )  AS COL6,
    SUM(CASE WHEN CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' THEN  D.COL7 ELSE NULL END)  AS COL7,
    SUM(CASE WHEN CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' THEN  D.COL8 ELSE NULL END)  AS COL8,
    SUM(CASE WHEN CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' THEN  D.COL9 ELSE NULL END)  AS COL9
FROM 
  VW_DATA_ALL D
