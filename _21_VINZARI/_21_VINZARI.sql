...
SELECT 
  ...
  SUM(CASE WHEN D.RIND IN ('16') AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' THEN D.COL1 END) AS NUME_ROW,
  SUM(CASE WHEN D.RIND IN ('16') AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' THEN D.COL2 END) AS COL1,
  SUM(CASE WHEN D.RIND IN ('16') AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' THEN D.COL4 END) AS COL3,
  SUM(CASE WHEN D.RIND IN ('16') AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' THEN D.COL5 END) AS COL4
FROM 
  VW_DATA_ALL D
...
SELECT 
  ...
  SUM(CASE WHEN D.RIND IN ('16') THEN D.COL1 END) AS NUME_ROW,
  SUM(CASE WHEN D.RIND IN ('16') THEN D.COL2 END) AS COL1,
  SUM(CASE WHEN D.RIND IN ('16') THEN D.COL4 END) AS COL3,
  SUM(CASE WHEN D.RIND IN ('16') THEN D.COL5 END) AS COL4
FROM 
  VW_DATA_ALL D
  INNER JOIN RENIM RN ON (D.CUIIO = RN.CUIIO AND D.CUIIO_VERS = RN.CUIIO_VERS)
WHERE
