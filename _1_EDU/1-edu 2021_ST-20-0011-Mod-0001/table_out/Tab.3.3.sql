...
FROM 
  CIS2.VW_DATA_ALL D
  INNER JOIN CIS2.VW_CL_CFP A ON (D.CFP=A.CODUL)
  INNER JOIN CIS2.VW_CL_CFP C ON (A.FULL_CODE LIKE '%'||C.CODUL||';%')
...
WHERE NUME_SECTIE LIKE '%PRIVATA%' OR NUME_SECTIE LIKE '%PUBLICA%'
)