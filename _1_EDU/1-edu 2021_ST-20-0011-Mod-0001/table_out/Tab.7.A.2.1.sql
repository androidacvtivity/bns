...
SELECT
  ...
  SUM(CASE WHEN  B.NR_ROW = D.RIND  AND C.CODUL =  CR.NR_ROW AND  E.NFI = 1 THEN D.COL2 ELSE 0 END ) AS COL1,
  SUM(CASE WHEN  B.NR_ROW = D.RIND  AND C.CODUL =  CR.NR_ROW AND  E.NFI = 1 THEN D.COL3 ELSE 0 END ) AS COL2,
  SUM(CASE WHEN  B.NR_ROW = D.RIND  AND C.CODUL =  CR.NR_ROW AND  E.NFI = 1 THEN D.COL4 ELSE 0 END ) AS COL3,
  SUM(CASE WHEN  B.NR_ROW = D.RIND  AND C.CODUL =  CR.NR_ROW AND  E.NFI = 1 THEN D.COL5 ELSE 0 END ) AS COL4,
  SUM(CASE WHEN  B.NR_ROW = D.RIND  AND C.CODUL =  CR.NR_ROW AND  E.NFI = 1 THEN D.COL6 ELSE 0 END ) AS COL5,
  SUM(CASE WHEN  B.NR_ROW = D.RIND  AND C.CODUL =  CR.NR_ROW AND  E.NFI = 1  THEN D.COL7 ELSE 0 END ) AS COL6,
  SUM(CASE WHEN  B.NR_ROW = D.RIND  AND C.CODUL =  CR.NR_ROW AND  E.NFI = 1 THEN D.COL8 ELSE 0 END ) AS COL7
...
SELECT '10'  AS NR_ROW, 'în limba ucraineană'    AS NUME_ROW,  14 AS ORDINE , '10' AS ORDINE_2 FROM DUAL  UNION
...
SELECT '10'  AS NR_ROW, 'în limba bulgară'    AS NUME_ROW,  19 AS ORDINE , '14' AS ORDINE_2 FROM DUAL  UNION
...
SELECT '10'  AS NR_ROW, 'în limba engleză'    AS NUME_ROW,  24 AS ORDINE , '18' AS ORDINE_2 FROM DUAL  UNION
