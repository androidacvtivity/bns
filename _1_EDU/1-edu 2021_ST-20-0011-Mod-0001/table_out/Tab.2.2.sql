...
FROM 
  ...
  INNER JOIN CIS2.VW_CL_COCM C ON (CIS2.D.COCM = C.CODUL)
  INNER JOIN CIS2.VW_CL_COCM CC ON (CIS2.C.FULL_CODE LIKE '%'||CIS2.CC.CODUL ||';%' )
...
WHERE 
  ...
  D.RIND IN ('19') AND
  C.CODUL IN ('8704','7094','4874','7614','7774','7994','8064','9994')
