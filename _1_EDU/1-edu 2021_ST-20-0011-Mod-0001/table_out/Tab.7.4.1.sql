...
SELECT DISTINCT
  ...
  CASE 
  WHEN CODUL_CUATM = '7184' THEN 'MINISTERUL SĂNĂTĂȚII'    
  WHEN CODUL_CUATM = '8704' THEN 'MINISTERUL EDUCAȚIEI ȘI CERCETĂRII'   
  ELSE 
  
  DENUMIRE_CUATM  END AS NUME_SECTIE,
  '0' AS NR_SECTIE1,
  '0' AS NUME_SECTIE1,
  '0' AS NR_SECTIE2,
  '0' AS NUME_SECTIE2,
...
WHERE 
  ...
  (D.CUATM_FULL LIKE '%' ||:pCOD_CUATM||';%') AND
   ...
   D.CAPITOL IN 1024 
   AND
   CC.CODUL IN ('8704','7094','4874','7614','7774','7994','8064','9994')
