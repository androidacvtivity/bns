...
FROM
    ...
    SELECT 
          ...
          FROM CIS2.DATA_ALL D 
                   ...
                   INNER JOIN CIS2.MD_CAPITOL MC ON (MR.CAPITOL = MC.CAPITOL AND MR.CAPITOL_VERS = MC.CAPITOL_VERS)
             
                   INNER JOIN CIS2.VW_CL_CUATM C ON (C.CODUL=R.CUATM) 
                   INNER JOIN CIS2.VW_CL_CAEM2  V ON V.CODUL = R.CAEM2 
                   INNER JOIN
        (
        SELECT 
               CM.CODUL,   
            ...
            ('00000','A0000','A0100','A0160','A0200','A0300','B0000','C0000','C1000','C1100','C1200','C1300','C1400','C1500','C1600','C1700','C1800','C1900','C2000',
             ...
             'M7112','R9320')
        ...
        ) R1 ON (V.FULL_CODE LIKE '%'||R1.CODUL||'%' AND MR.RIND = R1.NR_ROW)
               ...
               WHERE 
                ...
                MC.CAPITOL_VERS  <= :pPERIOADA AND         
                MC.CAPITOL IN (1009) AND 
