...
SELECT 
 ...
 NULL AS COL2,NULL AS COL3,NULL AS COL4
FROM 
  CIS2.VW_DATA_ALL D
...
GROUP BY 
 ...
 -----------------CUIIO----------------- 
  ...
  '0' AS NR_SECTIE2,
  '0' AS NUME_SECTIE2,  
 MAX( CASE WHEN  RTRIM (R.CUIIO,'0')   IN (5913188, 1309538,4607265,82066,820602) THEN
 RTRIM (R.CUIIO,'0')||'0' ELSE TO_CHAR(R.CUIIO)  END) AS NR_ROW,  
  CN.CODUL ||'.'||RTRIM (R.CUIIO,'0') AS ORDINE,
  '0000' AS DECIMAL_POS,
  R.DENUMIRE AS NUME_ROW,
  NULL AS COL1, NULL AS COL2,NULL AS COL3,NULL AS COL4
FROM 
  CIS2.VW_DATA_ALL D
  INNER JOIN CIS2.MD_RIND RD ON (D.ID_MD=RD.ID_MD)
  INNER JOIN CIS2.RENIM R ON (D.CUIIO=R.CUIIO AND D.CUIIO_VERS=R.CUIIO_VERS)
