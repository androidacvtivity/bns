...
NVAL(SUM(CASE WHEN D.PERIOADA IN (:PERIOADA)   THEN NVAL(D.COL1) ELSE 0 END)) ||' <> '||
NVAL(SUM(CASE WHEN D.PERIOADA IN (:PERIOADA-1) THEN NVAL(D.COL1) ELSE 0 END))
AS REZULTAT 
FROM
(
...
NVAL(SUM(CASE WHEN D.PERIOADA IN (:PERIOADA)   THEN NVAL(D.COL1) ELSE 0 END)) = 0
AND 
NVAL(SUM(CASE WHEN D.PERIOADA IN (:PERIOADA-1) THEN NVAL(D.COL1)ELSE 0 END)) = 0
)
