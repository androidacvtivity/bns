...
--SUM(CASE WHEN D.PERIOADA IN (:PERIOADA)   THEN  D.COL1 END) <> 
--SUM(CASE WHEN D.PERIOADA IN (:PERIOADA-1) THEN  D.COL1 END)



    
SUM(CASE WHEN D.PERIOADA IN (:PERIOADA)   THEN NVAL(D.COL1) END) <> 
SUM(CASE WHEN D.PERIOADA IN (:PERIOADA-1) THEN NVAL(D.COL1)  END)
