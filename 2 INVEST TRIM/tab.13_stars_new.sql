...
SUM(CASE WHEN D.PERIOADA IN :pPERIOADA  THEN NVAL(D.COL1)  ELSE 0 END)  /
 CIS.NOZERO(SUM(CASE WHEN D.PERIOADA IN :pPERIOADA - 4    THEN NVAL(D.COL1)   ELSE 0 END)) AS COL8,
  
SUM(CASE WHEN D.PERIOADA IN :pPERIOADA  THEN NVAL(D.COL2) ELSE 0 END)  /
 CIS.NOZERO(SUM(CASE WHEN D.PERIOADA IN :pPERIOADA - 4    THEN  NVAL(D.COL2) ELSE 0 END)) AS COL9
