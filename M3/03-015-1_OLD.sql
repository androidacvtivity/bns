...
CASE WHEN NVAL(SUM(CASE WHEN D.CAPITOL IN('303') THEN  D.COL9 ELSE 0 END)) <> 0 THEN
...
ROUND(( nval(SUM(CASE WHEN D.CAPITOL IN('303') THEN  D.COL2 ELSE 0 END))-
        ...
        nval(SUM(CASE WHEN D.CAPITOL IN('303') THEN  D.COL8 ELSE 0 END)))/
        nozero(NVAL(SUM(CASE WHEN D.CAPITOL IN('303') THEN  D.COL9 ELSE 0 END)))*100,2) 
  ELSE 0 END <= 0 
