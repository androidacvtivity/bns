...
--  '0' AS NUME_SECTIE2,
  ...
  ROUND((SUM(R.COL2)-SUM(R.COL7)-SUM(R.COL8)-SUM(R.COL9))/NOZERO(SUM(R.COL1))*1000/12,1) AS COL14,
  ROUND(MAX(TT.COL14),1) AS COL15,
  ROUND(((SUM(R.COL2)-SUM(R.COL7)-SUM(R.COL8)-SUM(R.COL9))/NOZERO(SUM(R.COL1))*1000/12)/NOZERO(MAX(TT.COL14))*100,1) AS COL16
...
FROM TABLE_OUT R
  ...
  WHERE  
   ...
   FORM IN (:pFORM) AND
   SUBSTR(NR_ROW,1,5) IN ('B0000','C0000','D0000','E0000')
