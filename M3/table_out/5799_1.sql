...
SELECT
  ...
  '11111111111111' AS DECIMAL_POS,
   ...
   ROUND(COL1,1) AS COL2,
   ROUND(D.COL2,1) AS COL3,
   ROUND(COL3,1) AS COL4,
   ROUND(COL4,1) AS COL5,
   ROUND(COL5,1) AS COL6,
   ROUND(COL6,1) AS COL7,
   ROUND(COL7,1) AS COL8,
   ROUND(COL8,1) AS COL9,
   ROUND(COL9,1) AS COL10,
   ROUND(NOZERO(COL1)/NOZERO(T1.COL2)*1000/12,1) AS COL11,
   ROUND(T2.COL11,1) AS COL12,
   ROUND(NOZERO(NOZERO(COL1)/NOZERO(T1.COL2)*1000/12)/NOZERO(T2.COL11)*100,1) AS COL13
...
SELECT 
  ...
  CR.FULL_CODE,
    SUM(NVAL(CASE WHEN CAPITOL IN (303) AND COL=2 THEN VAL ELSE NULL END)+
        ...
        NVAL(CASE WHEN CAPITOL IN (303) AND COL=5 THEN VAL ELSE NULL END)) AS COL1,
    
    SUM(NVAL(CASE WHEN CAPITOL IN (303) AND COL=2 THEN VAL ELSE NULL END)) AS COL2,
    SUM(NVAL(CASE WHEN CAPITOL IN (303) AND COL=3 THEN VAL ELSE NULL END)) AS COL3,
    SUM(NVAL(CASE WHEN CAPITOL IN (303) AND COL=4 THEN VAL ELSE NULL END)) AS COL4,
    SUM(NVAL(CASE WHEN CAPITOL IN (303) AND COL=5 THEN VAL ELSE NULL END)) AS COL5,
    SUM(NVAL(CASE WHEN CAPITOL IN (303) AND COL=6 THEN VAL ELSE NULL END)) AS COL6,
    SUM(NVAL(CASE WHEN CAPITOL IN (303) AND COL=7 THEN VAL ELSE NULL END)) AS COL7,
    SUM(NVAL(CASE WHEN CAPITOL IN (303) AND COL=8 THEN VAL ELSE NULL END)) AS COL8,
    SUM(NVAL(CASE WHEN CAPITOL IN (303) AND COL=9 THEN VAL ELSE NULL END)) AS COL9,
    SUM(NVAL(CASE WHEN CAPITOL IN (303) AND COL=10 THEN VAL ELSE NULL END)) AS COL10,
    SUM(NVAL(CASE WHEN CAPITOL IN (301) AND COL=2 THEN VAL ELSE NULL END)) AS COL11
FROM
(
-------------------------------------------------------------------------------
SELECT
...
WHERE
  ...
  D.FORM = 3 AND
  D.CAPITOL IN(301,303) AND D.CFP IN('28','29')
GROUP BY
  D.CUIIO,
  D.FILIAL,
  D.CAPITOL,
...
ORDER BY
   ...
   LEFT JOIN (SELECT NR_ROW, COL2, ID_MDTABLE FROM TABLE_OUT  
  
  WHERE  ID_MDTABLE =(5762) AND
    FORM IN (3)              AND 
 ...
 SELECT NR_ROW, COL11, ID_MDTABLE FROM TABLE_OUT  
  ...
  WHERE  
    ID_MDTABLE=(CASE WHEN :pPERIOADA<=2001 THEN 434 ELSE 5799 END) AND
