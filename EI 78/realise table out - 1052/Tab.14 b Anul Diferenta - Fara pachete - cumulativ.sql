...
SELECT 
    ...
    (SUM(CASE WHEN   D.CAPITOL IN (405)  AND D.RIND NOT IN ('1','-')  THEN NVAL(D.COL4) ELSE 0 END ))  
 ...
 C.FULL_CODE,
  ...
  SELECT 
    ...
    CI.NAME  DENUMIRE,
       ...
       (SUM(CASE WHEN    D.CAPITOL IN (405)  AND D.RIND NOT IN ('1','2','-')  THEN  NVAL(D.COL4) ELSE 0 END )  
    +
    SUM(CASE WHEN     D.CAPITOL IN (406)  AND D.RIND NOT IN ('1','-')  THEN  NVAL(D.COL4) ELSE 0 END ))
    AS COL2
