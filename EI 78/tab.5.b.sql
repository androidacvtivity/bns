...
SELECT
    ...
    NULL   AS  COL5,
    D.CUIIO   AS  COL6,
    MAX(CASE WHEN  D.CAPITOL IN (404) AND MR.RIND IN ('01') AND   D.COL1 = 1 THEN  1  
             WHEN  D.CAPITOL IN (404) AND MR.RIND IN ('02') AND   D.COL1 = 1 THEN  2
             WHEN  D.CAPITOL IN (404) AND MR.RIND IN ('03') AND   D.COL1 = 1 THEN  3
             WHEN  D.CAPITOL IN (404) AND MR.RIND IN ('04') AND   D.COL1 = 1 THEN  4
             WHEN  D.CAPITOL IN (404) AND MR.RIND IN ('05') AND   D.COL1 = 1 THEN  5
             WHEN  D.CAPITOL IN (404) AND MR.RIND IN ('06') AND   D.COL1 = 1 THEN  6
             WHEN  D.CAPITOL IN (404) AND MR.RIND IN ('07') AND   D.COL1 = 1 THEN  7  
