...
GROUP BY 
    ...
    SUM(CASE WHEN D.CAPITOL IN (405) AND TRIM(D.COL31) IN  ('49.41.1') THEN  1 ELSE 0  END)) >  0
    ...
    (
     ...
     SUM(CASE WHEN D.CAPITOL IN (407) AND TRIM(D.COL31) IN  ('52.29.1')   THEN  1 ELSE 0  END)   + 
     SUM(CASE WHEN D.CAPITOL IN (407) AND TRIM(D.COL31) IN  ('52.29.2')   THEN  1 ELSE 0  END)
    = 0
