...
--    A.COL3   COL4,
--    A.COL4   COL5,
--    ROUND((A.COL3 / CIS2.NOZERO(A.COL4)),1)   COL6 
--FROM 
--(
SELECT 
...
SELECT
    ...
    NULL   AS  COL5,
    D.CUIIO   AS  COL6,
    MAX(CASE WHEN  D.CAPITOL IN (404) AND MR.RIND IN ('01') AND   NVAL(D.COL1) = 1 THEN  1  
             WHEN  D.CAPITOL IN (404) AND MR.RIND IN ('02') AND   NVAL(D.COL1) = 1 THEN  2
             WHEN  D.CAPITOL IN (404) AND MR.RIND IN ('03') AND   NVAL(D.COL1) = 1 THEN  3
             WHEN  D.CAPITOL IN (404) AND MR.RIND IN ('04') AND   NVAL(D.COL1) = 1 THEN  4
             WHEN  D.CAPITOL IN (404) AND MR.RIND IN ('05') AND   NVAL(D.COL1) = 1 THEN  5
             WHEN  D.CAPITOL IN (404) AND MR.RIND IN ('06') AND   NVAL(D.COL1) = 1 THEN  6
             WHEN  D.CAPITOL IN (404) AND MR.RIND IN ('07') AND   NVAL(D.COL1) = 1 THEN  7  
...
SELECT 
  ...
  -- SUM(CASE WHEN D.COL4 IS NOT NULL THEN D.COL4 ELSE 0 END) COL3,
    (SUM(CASE WHEN  D.CAPITOL IN (411)  AND D.RIND NOT IN ('1','2','-') AND D.COL4 IS NOT NULL THEN D.COL4 ELSE 0 END )  
    +
    SUM(CASE WHEN  D.CAPITOL IN (403)  AND D.RIND NOT IN ('1','-') AND D.COL4 IS NOT NULL THEN D.COL4 ELSE 0 END ))
    AS COL3,
    ---------------------------------------------------------------------------------------------------------------------
  --  SUM(CASE WHEN D.COL5 IS NOT NULL THEN D.COL5 ELSE 0 END) COL4,
    
    (SUM(CASE WHEN  D.CAPITOL IN (411)  AND D.RIND NOT IN ('1','2','-') AND D.COL5 IS NOT NULL THEN D.COL5 ELSE 0 END )  
    +
    SUM(CASE WHEN  D.CAPITOL IN (403)  AND D.RIND NOT IN ('1','-') AND D.COL5 IS NOT NULL THEN D.COL5 ELSE 0 END ))
    AS COL4,
