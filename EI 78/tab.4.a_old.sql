...
SELECT
  ...
  SELECT 
    ...
    SUM(D.COL4) COL3,
    SUM(D.COL5) COL4,
    ROUND(SUM(DISTINCT CASE  WHEN   D.CUIIO = D.CUIIO  AND D.CAPITOL IN (405)  THEN CIS2.NOZERO(CIS2.NVAL(D.COL4))/CIS2.NVAL(D.COL5) ELSE NULL END),1)    AS COL5,
    NULL AS COL6,
    NULL AS COL7
...
SELECT 
  ...
  --  SUM(CASE WHEN D.COL5 IS NOT NULL THEN D.COL5 ELSE 0 END) COL4,
    ...
    --ROUND(SUM(DISTINCT CASE  WHEN   D.CUIIO = D.CUIIO  AND D.CAPITOL IN (405,406)  THEN CIS2.NOZERO(CIS2.NVAL(D.COL4))/CIS2.NVAL(D.COL5) ELSE NULL END),1)    AS COL5,
