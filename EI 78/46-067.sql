...
WHERE
  ...
  D.FORM||'.'||D.CAPITOL||'.'||D.RIND IN ('46.404.01','46.404.05','44.14.01','44.14.05')
  
  
  
   HAVING
   
   (SUM(CASE WHEN D.FORM||'.'||D.CAPITOL||'.'||D.RIND IN ('46.404.01')   THEN CIS2.NVAL(D.COL1) ELSE 0 END) +
   
   SUM(CASE WHEN D.FORM||'.'||D.CAPITOL||'.'||D.RIND IN ('46.404.05')   THEN CIS2.NVAL(D.COL1) ELSE 0 END) > 0)
   
   AND 
   
   
  (SUM(CASE WHEN D.FORM||'.'||D.CAPITOL||'.'||D.RIND IN ('44.14.01')   THEN CIS2.NVAL(D.COL1) ELSE 0 END) +
   
   SUM(CASE WHEN D.FORM||'.'||D.CAPITOL||'.'||D.RIND IN ('44.14.05')   THEN CIS2.NVAL(D.COL1) ELSE 0 END) = 0)
