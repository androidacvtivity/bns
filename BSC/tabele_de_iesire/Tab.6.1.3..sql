...
--  D.ID_MD_D,
  ...
  ROUND((CIS2.NVAL(L.COL2)/CIS2.NOZERO(CIS2.NVAL(L.COL3))) *100,1) AS COL2,
  ROUND((CIS2.NVAL(L.COL2)/CIS2.NOZERO(CIS2.NVAL(L.COL5))) *100,1) AS COL3,
  ROUND((CIS2.NVAL(L.COL4)/CIS2.NOZERO(CIS2.NVAL(L.COL6))) *100,1) AS COL4
FROM
(
SELECT
--  D.RIND_S,
...
--  D.ID_MD_D,
  ...
  SUM(CASE WHEN DD.CAPITOL IN (1017) THEN  DD.R000_6  ELSE NULL END) AS COL2,
  SUM(CASE WHEN DD.CAPITOL IN (1018) THEN  (DD.R2002_3 * 30)  ELSE NULL END) AS COL3,
  SUM(CASE WHEN DD.CAPITOL IN (1018) THEN  DD.R210_3   ELSE NULL END) AS COL4,
  SUM(CASE WHEN DD.CAPITOL IN (1018) THEN  (DD.R220_3 * 30)  ELSE NULL END) AS COL5,
  SUM(CASE WHEN DD.CAPITOL IN (1018) THEN  (DD.R200_3 * 30)  ELSE NULL END) AS COL6,
  SUM(CASE WHEN DD.CAPITOL IN (1018) THEN  0  + 30  + 0 ELSE NULL END) AS COL7  
...
-- 
--  ROUND(L.COL1,1) AS COL1,
  ROUND((CIS2.NVAL(LL.COL2)/CIS2.NOZERO(CIS2.NVAL(LL.COL3))) *100,1) AS COL2,
  ROUND((CIS2.NVAL(LL.COL2)/CIS2.NOZERO(CIS2.NVAL(LL.COL5))) *100,1) AS COL3,
  ROUND((CIS2.NVAL(LL.COL4)/CIS2.NOZERO(CIS2.NVAL(LL.COL6))) *100,1) AS COL4
