...
SELECT
     ...
     CIS2.NVAL(COUNT(DISTINCT CASE WHEN  D.CAPITOL IN (1004) AND RIND_VERS IN (2007) AND  NS.CODUL = 1 AND  NT.CODUL <> 6 THEN D.CUIIO ELSE NULL END))  AS  COL2,
...
--               D.CUIIO IN (7001770)
     ...
     '02' AS NR_ROW,
      2  AS ORDINE,
     'grădiniţă de copii' AS NUME_ROW,
       CIS2.NVAL(COUNT(DISTINCT CASE WHEN  D.CAPITOL IN (1004) AND  RIND_VERS IN (2007)  AND NT.CODUL =  1 THEN D.CUIIO ELSE NULL END))  AS  COL1,  
       CIS2.NVAL(COUNT(DISTINCT CASE WHEN  D.CAPITOL IN (1004) AND  RIND_VERS IN (2007)  AND NT.CODUL =  1 AND NS.CODUL = 1 THEN D.CUIIO ELSE NULL END)) AS  COL2,
...
--               D.CUIIO IN (7001770)
     ...
     '03' AS NR_ROW,
      3  AS ORDINE,
     'creşă-grădiniţă' AS NUME_ROW,
       CIS2.NVAL(COUNT(DISTINCT CASE WHEN  D.CAPITOL IN (1004) AND  RIND_VERS IN (2007)  AND NT.CODUL =  2 THEN D.CUIIO ELSE NULL END))  AS  COL1, 
       CIS2.NVAL(COUNT(DISTINCT CASE WHEN  D.CAPITOL IN (1004) AND  RIND_VERS IN (2007)  AND NT.CODUL =  2 AND  NS.CODUL = 1 THEN D.CUIIO ELSE NULL END))  AS  COL2,
...
--              D.CUIIO IN (7001770)
     ...
     '04' AS NR_ROW,
      4  AS ORDINE,
     'creşă' AS NUME_ROW,
       CIS2.NVAL(COUNT(DISTINCT CASE WHEN  D.CAPITOL IN (1004) AND  RIND_VERS IN (2007)  AND NT.CODUL =  3 THEN D.CUIIO ELSE NULL END))  AS  COL1, 
       CIS2.NVAL(COUNT(DISTINCT CASE WHEN  D.CAPITOL IN (1004) AND  RIND_VERS IN (2007)  AND NT.CODUL =  3 AND  NS.CODUL = 1 THEN D.CUIIO ELSE NULL END))  AS  COL2,
...
--               D.CUIIO IN (7001770)
     ...
     '05' AS NR_ROW,
      5  AS ORDINE,
     'şcoală-grădiniţă de copii' AS NUME_ROW,
       CIS2.NVAL(COUNT(DISTINCT CASE WHEN  D.CAPITOL IN (1004) AND  RIND_VERS IN (2007)  AND NT.CODUL =  4 THEN D.CUIIO ELSE NULL END))  AS  COL1, 
       CIS2.NVAL(COUNT(DISTINCT CASE WHEN  D.CAPITOL IN (1004) AND  RIND_VERS IN (2007)  AND NT.CODUL =  4 AND  NS.CODUL = 1 THEN D.CUIIO ELSE NULL END))  AS  COL2,
...
--               D.CUIIO IN (7001770)
     ...
     'centru comunitar' AS NUME_ROW,
      CIS2.NVAL(COUNT(DISTINCT CASE WHEN  D.CAPITOL IN (1004) AND  RIND_VERS IN (2007)  AND NT.CODUL =  5 THEN D.CUIIO ELSE NULL END))  AS  COL1, 
       CIS2.NVAL(COUNT(DISTINCT CASE WHEN  D.CAPITOL IN (1004) AND  RIND_VERS IN (2007)  AND NT.CODUL =  5 AND  NS.CODUL = 1 THEN D.CUIIO ELSE NULL END))  AS  COL2,
...
--               D.CUIIO IN (7001770)
     ...
     '07' AS NR_ROW,
      7  AS ORDINE,
     'grupe pregătitoare pe lîngă instituţii de învăţămînt' AS NUME_ROW,
       NULL AS  COL1, 
       NULL AS  COL2,
