...
SELECT
     ...
     '01' AS NR_ROW,
      1  AS ORDINE,
     'Total' AS NUME_ROW,
     CIS2.NVAL(COUNT(DISTINCT CASE WHEN  D.CAPITOL IN (1004) AND  D.RIND_VERS IN (2007) AND  NT.CODUL <> 6 THEN D.CUIIO ELSE NULL END))  AS  COL1, 
     CIS2.NVAL(COUNT(DISTINCT CASE WHEN  D.CAPITOL IN (1004) AND  D.RIND_VERS IN (2007)  AND NS.CODUL = 1 AND  NT.CODUL <> 6 THEN D.CUIIO ELSE NULL END))  AS  COL2,
     ...
     CIS2.NVAL(SUM(CASE WHEN D.CAPITOL IN (1002) AND D.RIND IN ('020')  THEN D.COL1 ELSE NULL END)) AS  COL14
       ...
       FROM    
             CIS2.VW_DATA_ALL D    
               ...
               INNER JOIN CIS2.VW_CL_CFP CFP ON (CC.FULL_CODE LIKE '%'||CFP.CODUL||';%')                                          --4
               ----------------------------------------------------------------------------------------------------
     ...
     'gradinita de copii' AS NUME_ROW,
       CIS2.NVAL(COUNT(DISTINCT CASE WHEN  D.CAPITOL IN (1004) AND  D.RIND_VERS IN (2007) AND  NT.CODUL =  1 THEN D.CUIIO ELSE NULL END))  AS  COL1,  
       CIS2.NVAL(COUNT(DISTINCT CASE WHEN  D.CAPITOL IN (1004) AND  D.RIND_VERS IN (2007) AND  NT.CODUL =  1 AND NS.CODUL = 1 THEN D.CUIIO ELSE NULL END)) AS  COL2,
     ...
     'cresa-gradinita' AS NUME_ROW,
       CIS2.NVAL(COUNT(DISTINCT CASE WHEN  D.CAPITOL IN (1004) AND  D.RIND_VERS IN (2007)  AND  NT.CODUL =  2 THEN D.CUIIO ELSE NULL END))  AS  COL1, 
       CIS2.NVAL(COUNT(DISTINCT CASE WHEN  D.CAPITOL IN (1004) AND  D.RIND_VERS IN (2007)  AND  NT.CODUL =  2 AND  NS.CODUL = 1 THEN D.CUIIO ELSE NULL END))  AS  COL2,
     ...
     '04' AS NR_ROW,
      4  AS ORDINE,
     'cresa' AS NUME_ROW,
       CIS2.NVAL(COUNT(DISTINCT CASE WHEN  D.CAPITOL IN (1004) AND  D.RIND_VERS IN (2007) AND  NT.CODUL =  3 THEN D.CUIIO ELSE NULL END))  AS  COL1, 
       CIS2.NVAL(COUNT(DISTINCT CASE WHEN  D.CAPITOL IN (1004) AND  D.RIND_VERS IN (2007) AND  NT.CODUL =  3 AND  NS.CODUL = 1 THEN D.CUIIO ELSE NULL END))  AS  COL2,
     ...
     'scoala-gradinita de copii' AS NUME_ROW,
       CIS2.NVAL(COUNT(DISTINCT CASE WHEN  D.CAPITOL IN (1004) AND  D.RIND_VERS IN (2007)  AND  NT.CODUL =  4 THEN D.CUIIO ELSE NULL END))  AS  COL1, 
       CIS2.NVAL(COUNT(DISTINCT CASE WHEN  D.CAPITOL IN (1004) AND  D.RIND_VERS IN (2007)  AND  NT.CODUL =  4 AND  NS.CODUL = 1 THEN D.CUIIO ELSE NULL END))  AS  COL2,
     ...
     'centru comunitar' AS NUME_ROW,
      CIS2.NVAL(COUNT(DISTINCT CASE WHEN  D.CAPITOL IN (1004)  AND  D.RIND_VERS IN (2007) AND  NT.CODUL =  5 THEN D.CUIIO ELSE NULL END))  AS  COL1, 
       CIS2.NVAL(COUNT(DISTINCT CASE WHEN  D.CAPITOL IN (1004) AND  D.RIND_VERS IN (2007)  AND  NT.CODUL =  5 AND  NS.CODUL = 1 THEN D.CUIIO ELSE NULL END))  AS  COL2,
