...
UNION
  -- ROWS 02               
     ...
     'inclusiv cu destinatie:generala' AS NUME_ROW,
       CIS2.NVAL(COUNT(DISTINCT CASE WHEN  D.CAPITOL IN (1004)  AND D.RIND_VERS IN (2007)  AND  ND.CODUL = '1' AND  NT.CODUL <> '6' THEN D.CUIIO ELSE NULL END))  AS  COL1, 
  ...
  -- ROWS 03               
     ...
     'sanatoriala' AS NUME_ROW,
       CIS2.NVAL(COUNT(DISTINCT CASE WHEN  D.CAPITOL IN (1004) AND D.RIND_VERS IN (2007)  AND  ND.CODUL = '2' AND  NT.CODUL <> '6' THEN D.CUIIO ELSE NULL END))  AS  COL1, 
  ...
  -- ROWS 04               
     ...
     'speciala' AS NUME_ROW,
       CIS2.NVAL(COUNT(DISTINCT CASE WHEN  D.CAPITOL IN (1004) AND D.RIND_VERS IN (2007)    AND ND.CODUL = '3' AND  NT.CODUL <> '6' THEN D.CUIIO ELSE NULL END))  AS  COL1, 
