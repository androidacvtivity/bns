...
SELECT 
  ...
  MR.RIND_VERS,
  MR.DENUMIRE,
  ROUND(SUM(CASE WHEN CD.CFP LIKE '%' ||RN.CFP||'%'  THEN  CIS2.NVAL(D.COL1) END),1)  AS COL1,
  ROUND(SUM(CASE WHEN CD.CFP LIKE '%' ||RN.CFP||'%'  THEN  CIS2.NVAL(D.COL2) END),1)  AS COL2,
  ROUND(SUM(CASE WHEN CD.CFP LIKE '%' ||RN.CFP||'%'  THEN  CIS2.NVAL(D.COL3) END),1)  AS COL3,
  ROUND(SUM(CASE WHEN CD.CFP LIKE '%' ||RN.CFP||'%'  THEN  CIS2.NVAL(D.COL4) END),1)  AS COL4,
  ROUND(SUM(CASE WHEN CD.CFP LIKE '%' ||RN.CFP||'%'  THEN  CIS2.NVAL(D.COL5) END),1)  AS COL5,
  ROUND(SUM(CASE WHEN CD.CFP LIKE '%' ||RN.CFP||'%'  THEN  CIS2.NVAL(D.COL6) END),1)  AS COL6,
  ROUND(SUM(CASE WHEN CD.CFP LIKE '%' ||RN.CFP||'%'  THEN  CIS2.NVAL(D.COL7) END),1)  AS COL7,
  ROUND(SUM(CASE WHEN CD.CFP LIKE '%' ||RN.CFP||'%'  THEN  CIS2.NVAL(D.COL8) END),1)  AS COL8,
  ROUND(SUM(CASE WHEN CD.CFP LIKE '%' ||RN.CFP||'%'  THEN  CIS2.NVAL(D.COL9) END),1)  AS COL9,
  ROUND(SUM(CASE WHEN CD.CFP LIKE '%' ||RN.CFP||'%'  THEN  CIS2.NVAL(D.COL10) END),1) AS COL10
