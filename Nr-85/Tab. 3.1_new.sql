...
SELECT
  ...
  REPLACE(REPLACE(REPLACE(CR.DENUMIRE,'<b>',''),'</b>',''),'<br>','') NUME_ROW,
   ...
   ROUND(SUM(CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%' AND CR.RIND = MR.RIND  THEN  D.COL14 END),1) AS COL14, 
   ROUND(SUM(CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%' AND CR.RIND = MR.RIND THEN   D.COL15 END),1) AS COL15,
   ROUND(SUM(CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%' AND CR.RIND = MR.RIND THEN   D.COL16 END),1) AS COL16,
   ROUND(SUM(CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%' AND CR.RIND = MR.RIND THEN   D.COL17 END),1) AS COL17,
   ROUND(SUM(CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%' AND CR.RIND = MR.RIND THEN   D.COL18 END),1) AS COL18,
   ROUND(SUM(CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%' AND CR.RIND = MR.RIND THEN   D.COL19 END),1) AS COL19,
   ROUND(SUM(CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%' AND CR.RIND = MR.RIND THEN   D.COL20 END),1) AS COL20,
   ROUND(SUM(CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%' AND CR.RIND = MR.RIND  THEN  D.COL21 END),1) AS COL21,
   ROUND(SUM(CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%' AND CR.RIND = MR.RIND THEN   D.COL22 END),1) AS COL22,
   ROUND(SUM(CASE WHEN VC.FULL_CODE LIKE '%'||CD.CUATM||';%' AND CR.RIND = MR.RIND THEN   D.COL23 END),1) AS COL23
