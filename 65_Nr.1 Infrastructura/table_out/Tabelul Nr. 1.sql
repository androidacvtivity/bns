...
SELECT
   ...
   NVAL(SUM(CASE WHEN D.CAPITOL IN (1131) AND D.RIND IN ('07') THEN D.COL1 ELSE NULL END)) AS COL7,
   NVAL(SUM(CASE WHEN D.CAPITOL IN (1131) AND D.RIND IN ('08') THEN D.COL1 ELSE NULL END)) AS COL8,
   NVAL(SUM(CASE WHEN D.CAPITOL IN (1131) AND D.RIND IN ('09') THEN D.COL1 ELSE NULL END)) AS COL9,
   NVAL(SUM(CASE WHEN D.CAPITOL IN (1131) AND D.RIND IN ('10') THEN D.COL1 ELSE NULL END)) AS COL10,
   NVAL(SUM(CASE WHEN D.CAPITOL IN (1131) AND D.RIND IN ('11') THEN D.COL1 ELSE NULL END)) AS COL11,
   NVAL(SUM(CASE WHEN D.CAPITOL IN (1131) AND D.RIND IN ('12') THEN D.COL1 ELSE NULL END)) AS COL12
FROM
  VW_DATA_ALL D
