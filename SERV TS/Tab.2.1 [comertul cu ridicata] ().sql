...
SELECT
 ...
 CIS.NVAL(SUM(CASE WHEN D.PERIOADA BETWEEN FLOOR(:pPERIOADA/12)*12 AND :pPERIOADA THEN COL1 END)/
  CIS.NOZERO(SUM(CASE WHEN D.PERIOADA BETWEEN FLOOR((:pPERIOADA-12)/12)*12 AND :pPERIOADA-12 THEN COL1 END)))*100 AS COL2,
 ...
 CIS.NVAL(SUM(CASE WHEN D.PERIOADA IN :pPERIOADA THEN COL1 END)/
  CIS.NOZERO(SUM(CASE WHEN D.PERIOADA IN :pPERIOADA-1 THEN COL1 END)))*100 AS COL4,
  
  CIS.NVAL(SUM(CASE WHEN D.PERIOADA IN :pPERIOADA THEN COL1 END)/
  CIS.NOZERO(SUM(CASE WHEN D.PERIOADA IN :pPERIOADA-12 THEN COL1 END)))*100  AS COL5
