...
SELECT 
 ...
 ((CIS2.NVAL(SUM(CASE WHEN    (D.PERIOADA = :pPERIOADA - 2)    AND  D.CAPITOL IN ('1111') AND D.RIND IN (RR.RIND)  AND D.CUATM_FULL LIKE '%'||1111111||';%' THEN D.COL2 ELSE NULL END))/10000)/
     ...
     +
      ...
      ((CIS2.NVAL(SUM(CASE WHEN  (D.PERIOADA BETWEEN FLOOR(:pPERIOADA/4)*4 AND :pPERIOADA)   AND  D.CAPITOL IN ('1110') AND D.RIND IN ('006')  AND D.CUATM_FULL LIKE '%'||1111111||';%' THEN D.COL2 ELSE NULL END))/3) 
      
      + 
       CIS2.NOZERO(CIS2.NVAL(SUM(CASE WHEN(D.PERIOADA BETWEEN FLOOR(:pPERIOADA/4)*4 AND :pPERIOADA)   AND   D.CAPITOL IN ('1110') AND D.RIND IN ('007')    AND D.CUATM_FULL LIKE '%'||1111111||';%' THEN D.COL2 ELSE NULL END))/3))))  
 ...
 ((CIS2.NVAL(SUM(CASE WHEN    (D.PERIOADA = :pPERIOADA - 2)    AND  D.CAPITOL IN ('1111') AND D.RIND IN (RR.RIND)  AND ((D.CUATM_FULL LIKE '%'||2222222||';%') OR (D.CUATM_FULL LIKE '%0100000;%'))   THEN D.COL2 ELSE NULL END))/10000)/
     ...
     +
      ...
      ((CIS2.NVAL(SUM(CASE WHEN  (D.PERIOADA BETWEEN FLOOR(:pPERIOADA/4)*4 AND :pPERIOADA)   AND  D.CAPITOL IN ('1110') AND D.RIND IN ('006')  AND ((D.CUATM_FULL LIKE '%'||2222222||';%') OR (D.CUATM_FULL LIKE '%0100000;%'))  THEN D.COL2 ELSE NULL END))/3) 
      
      + 
       CIS2.NOZERO(CIS2.NVAL(SUM(CASE WHEN(D.PERIOADA BETWEEN FLOOR(:pPERIOADA/4)*4 AND :pPERIOADA)   AND   D.CAPITOL IN ('1110') AND D.RIND IN ('007')    AND ((D.CUATM_FULL LIKE '%'||2222222||';%') OR (D.CUATM_FULL LIKE '%0100000;%'))  THEN D.COL2 ELSE NULL END))/3))))  
 ...
 ((CIS2.NVAL(SUM(CASE WHEN    (D.PERIOADA = :pPERIOADA - 2)    AND  D.CAPITOL IN ('1111') AND D.RIND IN (RR.RIND)  AND ((D.CUATM_FULL LIKE '%'||3333333||';%') OR (D.CUATM_FULL LIKE '%'||9600000||';%'))   THEN D.COL2 ELSE NULL END))/10000)/
     ...
     +
      ...
      ((CIS2.NVAL(SUM(CASE WHEN  (D.PERIOADA BETWEEN FLOOR(:pPERIOADA/4)*4 AND :pPERIOADA)   AND  D.CAPITOL IN ('1110') AND D.RIND IN ('006')  AND ((D.CUATM_FULL LIKE '%'||3333333||';%') OR (D.CUATM_FULL LIKE '%'||9600000||';%'))  THEN D.COL2 ELSE NULL END))/3) 
      
      + 
       CIS2.NOZERO(CIS2.NVAL(SUM(CASE WHEN(D.PERIOADA BETWEEN FLOOR(:pPERIOADA/4)*4 AND :pPERIOADA)   AND   D.CAPITOL IN ('1110') AND D.RIND IN ('007')    AND ((D.CUATM_FULL LIKE '%'||3333333||';%') OR (D.CUATM_FULL LIKE '%'||9600000||';%'))   THEN D.COL2 ELSE NULL END))/3))))  
...
ROUND(
 ...
 ((CIS2.NVAL(SUM(CASE WHEN    (D.PERIOADA = :pPERIOADA - 2)    AND  D.CAPITOL IN ('1111') AND D.RIND IN (RR.RIND)  AND  D.CUATM_FULL LIKE '%'||:pCOD_CUATM||';%'   THEN D.COL2 ELSE NULL END))/10000)/
     ...
     +
      ...
      ((CIS2.NVAL(SUM(CASE WHEN  (D.PERIOADA BETWEEN FLOOR(:pPERIOADA/4)*4 AND :pPERIOADA)   AND  D.CAPITOL IN ('1110') AND D.RIND IN ('006')  AND  D.CUATM_FULL LIKE '%'||:pCOD_CUATM||';%'  THEN D.COL2 ELSE NULL END))/3) 
      
      + 
       CIS2.NOZERO(CIS2.NVAL(SUM(CASE WHEN(D.PERIOADA BETWEEN FLOOR(:pPERIOADA/4)*4 AND :pPERIOADA)   AND   D.CAPITOL IN ('1110') AND D.RIND IN ('007')    AND  D.CUATM_FULL LIKE '%'||:pCOD_CUATM||';%'    THEN D.COL2 ELSE NULL END))/3))))  
  ...
  SELECT  RIND, DENUMIRE,ORDINE 
               FROM    CIS2.MD_RIND       
               WHERE   FORM= 61 AND CAPITOL = 1111 AND RIND NOT IN ('-','101','110') ORDER BY ORDINE
