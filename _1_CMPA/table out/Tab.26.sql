...
SELECT 
         ...
         CIS2.NVAL(SUM(CASE WHEN D.CAPITOL IN ('1113') AND D.RIND IN ('210','220','230','240')  AND D.CUATM_FULL LIKE '%'||1111111||';%' THEN D.COL4 ELSE NULL END)) AS COL4, 
         CIS2.NVAL(SUM(CASE WHEN D.CAPITOL IN ('1113') AND D.RIND IN ('210','220','230','240')  AND D.CUATM_FULL LIKE '%'||1111111||';%' THEN D.COL5 ELSE NULL END)) AS COL5,
         NULL AS COL6,
