SELECT  
'Rind.' ||D.RIND||' : '||
CIS2.NVAL(SUM(CASE WHEN D.CAPITOL IN ('1112') AND D.RIND IN ('010','011','012','013','014','015','016','017','020','021','022','023','024','030') AND  P.PERIOADA=:PERIOADA  THEN NVAL(D.COL1)  ELSE NULL END))||' > '||  
CIS2.NVAL(SUM(CASE WHEN D.CAPITOL IN ('1111') AND D.RIND IN ('010','011','012','013','014','015','016','017','020','021','022','023','024','030') AND P.NUM = 2    THEN NVAL(D.COL1)  ELSE NULL END))
  AS REZULTAT
