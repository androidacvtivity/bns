...
--  (D.PERIOADA = :PPERIOADA)  AND
 ...
 SELECT 
         ...
         CIS2.NVAL(SUM(CASE WHEN D.CAPITOL IN ('1113') AND D.RIND IN ('310','320','330','340','350','360')  AND D.CUATM_FULL LIKE '%'||1111111||';%' THEN D.COL1 ELSE NULL END)) / 3  AS COL1,
         CIS2.NVAL(SUM(CASE WHEN D.CAPITOL IN ('1113') AND D.RIND IN ('310','320','330','340','350','360')  AND D.CUATM_FULL LIKE '%'||1111111||';%' THEN D.COL2 ELSE NULL END)) / 3 AS COL2,
         ...
         NOZERO (CIS2.NVAL(SUM(CASE WHEN D.CAPITOL IN ('1113') AND D.RIND IN ('310','320','330','340','350','360')  AND D.CUATM_FULL LIKE '%'||1111111||';%' THEN D.COL2 ELSE NULL END)) / 3) AS COL4,
            
         CIS2.NVAL(SUM(CASE WHEN D.CAPITOL IN ('1113') AND D.RIND IN ('310','320','330','340','350','360') AND D.CUATM_FULL LIKE '%'||2222222||';%' THEN D.COL1 ELSE NULL END)) / 3 AS COL5,
         CIS2.NVAL(SUM(CASE WHEN D.CAPITOL IN ('1113') AND D.RIND IN ('310','320','330','340','350','360')  AND D.CUATM_FULL LIKE '%'||2222222||';%' THEN D.COL2 ELSE NULL END)) / 3 AS COL6,
         ...
         NOZERO (CIS2.NVAL(SUM(CASE WHEN D.CAPITOL IN ('1113') AND D.RIND IN ('310','320','330','340','350','360')  AND D.CUATM_FULL LIKE '%'||2222222||';%' THEN D.COL2 ELSE NULL END)) / 3) AS COL8,
         ...
         CIS2.NVAL(SUM(CASE WHEN D.CAPITOL IN ('1113') AND D.RIND IN ('310','320','330','340','350','360')  AND  ((D.CUATM_FULL LIKE '%'||3333333||';%') OR (D.CUATM_FULL LIKE '%'||9600000||';%')) THEN D.COL2 ELSE NULL END)) / 3 AS COL10,
         ...
         NOZERO (CIS2.NVAL(SUM(CASE WHEN D.CAPITOL IN ('1113') AND D.RIND IN ('310','320','330','340','350','360')  AND  ((D.CUATM_FULL LIKE '%'||3333333||';%') OR (D.CUATM_FULL LIKE '%'||9600000||';%')) THEN D.COL2 ELSE NULL END)) / 3) AS COL12,
         ...
         CIS2.NVAL(SUM(CASE WHEN D.CAPITOL IN ('1113') AND D.RIND IN ('310','320','330','340','350','360')  AND D.CUATM_FULL LIKE '%'||:PCOD_CUATM||';%' THEN D.COL2 ELSE NULL END)) / 3 AS COL14,
         ...
         NOZERO (CIS2.NVAL(SUM(CASE WHEN D.CAPITOL IN ('1113') AND D.RIND IN ('310','320','330','340','350','360')  AND D.CUATM_FULL LIKE '%'||:PCOD_CUATM||';%' THEN D.COL2 ELSE NULL END)) / 3) AS COL16
 ...
 (D.CUATM_FULL LIKE '%'||:PCOD_CUATM||';%') AND
  ...
  UNION
   ...
   SELECT 
         ...
         CIS2.NVAL(SUM(CASE WHEN D.CAPITOL IN ('1113') AND D.RIND IN ('400')  AND D.CUATM_FULL LIKE '%'||1111111||';%' THEN D.COL1 ELSE NULL END)) / 3 AS COL1,
         CIS2.NVAL(SUM(CASE WHEN D.CAPITOL IN ('1113') AND D.RIND IN ('400')  AND D.CUATM_FULL LIKE '%'||1111111||';%' THEN D.COL4 ELSE NULL END)) / 3 AS COL2,
         CIS2.NVAL(SUM(CASE WHEN D.CAPITOL IN ('1113') AND D.RIND IN ('400')  AND D.CUATM_FULL LIKE '%'||1111111||';%' THEN D.COL7 ELSE NULL END)) / 3 AS COL3, 
         CIS2.NVAL(SUM(CASE WHEN D.CAPITOL IN ('1113') AND D.RIND IN ('400')  AND D.CUATM_FULL LIKE '%'||1111111||';%' THEN D.COL7 ELSE NULL END))/
         NOZERO (CIS2.NVAL(SUM(CASE WHEN D.CAPITOL IN ('1113') AND D.RIND IN ('400')  AND D.CUATM_FULL LIKE '%'||1111111||';%' THEN D.COL4 ELSE NULL END)) / 3) AS COL4,
            
         CIS2.NVAL(SUM(CASE WHEN D.CAPITOL IN ('1113') AND D.RIND IN ('400')  AND D.CUATM_FULL LIKE '%'||2222222||';%' THEN D.COL1 ELSE NULL END)) / 3 AS COL5,
         CIS2.NVAL(SUM(CASE WHEN D.CAPITOL IN ('1113') AND D.RIND IN ('400')  AND D.CUATM_FULL LIKE '%'||2222222||';%' THEN D.COL4 ELSE NULL END)) / 3 AS COL6,
         ...
         NOZERO (CIS2.NVAL(SUM(CASE WHEN D.CAPITOL IN ('1113') AND D.RIND IN ('400')  AND D.CUATM_FULL LIKE '%'||2222222||';%' THEN D.COL4 ELSE NULL END)) / 3) AS COL8, 
         
         
         CIS2.NVAL(SUM(CASE WHEN D.CAPITOL IN ('1113') AND D.RIND IN ('400')  AND  ((D.CUATM_FULL LIKE '%'||3333333||';%') OR (D.CUATM_FULL LIKE '%'||9600000||';%')) THEN D.COL1 ELSE NULL END)) / 3 AS COL9,
         CIS2.NVAL(SUM(CASE WHEN D.CAPITOL IN ('1113') AND D.RIND IN ('400')  AND  ((D.CUATM_FULL LIKE '%'||3333333||';%') OR (D.CUATM_FULL LIKE '%'||9600000||';%')) THEN D.COL4 ELSE NULL END)) / 3 AS COL10,
         ...
         NOZERO (CIS2.NVAL(SUM(CASE WHEN D.CAPITOL IN ('1113') AND D.RIND IN ('400')  AND  ((D.CUATM_FULL LIKE '%'||3333333||';%') OR (D.CUATM_FULL LIKE '%'||9600000||';%')) THEN D.COL2 ELSE NULL END)) / 3 ) AS COL12,
         
         CIS2.NVAL(SUM(CASE WHEN D.CAPITOL IN ('1113') AND D.RIND IN ('400')  AND D.CUATM_FULL LIKE '%'||:PCOD_CUATM||';%' THEN D.COL1 ELSE NULL END)) / 3 AS COL13,
         CIS2.NVAL(SUM(CASE WHEN D.CAPITOL IN ('1113') AND D.RIND IN ('400')  AND D.CUATM_FULL LIKE '%'||:PCOD_CUATM||';%' THEN D.COL4 ELSE NULL END)) / 3 AS COL14,
         ...
         NOZERO (CIS2.NVAL(SUM(CASE WHEN D.CAPITOL IN ('1113') AND D.RIND IN ('400')  AND D.CUATM_FULL LIKE '%'||:PCOD_CUATM||';%' THEN D.COL4 ELSE NULL END)) / 3) AS COL16
...
WHERE
 ...
 (D.CUATM_FULL LIKE '%'||:PCOD_CUATM||';%') AND
  ...
  SELECT 
         ...
         CIS2.NVAL(SUM(CASE WHEN D.CAPITOL IN ('1113') AND D.RIND IN ('210','220','230','240','310','320','330','340','350','360','400','500')  AND D.CUATM_FULL LIKE '%'||1111111||';%' THEN D.COL1 ELSE NULL END)) / 3 AS COL1,
         ...
         CIS2.NVAL(SUM(CASE WHEN D.CAPITOL IN ('1113') AND D.RIND IN ('400','500')  AND D.CUATM_FULL LIKE '%'||1111111||';%' THEN D.COL4 ELSE NULL END)) ) / 3  AS COL2,
