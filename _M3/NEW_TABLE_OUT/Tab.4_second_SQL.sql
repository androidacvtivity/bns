...
SELECT
  ...
  '0111111111111111' AS DECIMAL_POS,
  ...
  ROUND(SUM(R.COL2)/NOZERO(SUM(R.COL1))*1000/12,1) AS COL11,
  ROUND(MAX(TT.COL11),1) AS COL12,
  ROUND(SUM(R.COL2)/NOZERO(SUM(R.COL1))*1000/12/MAX(TT.COL11)*100,1) AS COL13,
  
  
  ROUND(((NVAL(SUM(R.COL3))+NVAL(SUM(R.COL5))+NVAL(SUM(R.COL6))) - NVAL(SUM(R.COL7)) - NVAL(SUM(R.COL8)) )/NOZERO(SUM(R.COL1))*1000/12,1) AS COL14,
  
  ROUND(MAX(TT.COL14),1) AS COL15,
  -------------------------------------------------------------------------------------------------------------------------------------------
  
  ROUND((((SUM(R.COL3)+SUM(R.COL5)+SUM(R.COL6))-SUM(R.COL7)-SUM(R.COL8))/NOZERO(SUM(R.COL1))*1000/12)/NOZERO(MAX(TT.COL14))*100,1) AS COL16
