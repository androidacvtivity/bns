...
SELECT
  ...
  '1111111111111111' AS DECIMAL_POS,
   DENUMIRE AS NUME_ROW,  
    ...
    D.COL2 /T1.COL2 * 1000 / 12 COL11,
    ROUND(T2.COL11,1) AS COL12,
     ROUND(((D.COL2 /NOZERO(T1.COL2) * 1000 / 12) / NOZERO(T2.COL11)) * 100,1) AS COL13,
     ROUND(NOZERO( (NVAL(D.COL2) - NVAL(D.COL7) - NVAL(D.COL8) - NVAL(D.COL9) )/NOZERO(T1.COL2)*1000/12),1) AS COL14,
    ROUND(T2.COL14,1) AS COL15,
    ROUND(NOZERO( (NVAL(D.COL2) - NVAL(D.COL7) - NVAL(D.COL8) - NVAL(D.COL9)  )/NOZERO(T1.COL2)*1000/12/NOZERO(T2.COL14)* 100),1) AS COL16
     
   
--    NULL AS COL7,
--    ROUND(D.COL7,1) AS COL8,
--    ROUND(D.COL8,1) AS COL9,
--   
--     NULL AS COL10,
--    
...
--    ROUND(NOZERO( (NVAL(D.COL3)+ NVAL(COL5) + NVAL(COL6))- NVAL(COL7) - NVAL(COL8) )/NOZERO(T1.COL2)*1000/12,1) AS COL14,
--    ROUND(T2.COL14,1) AS COL15,
--    ROUND(NOZERO( (NVAL(D.COL3)+ NVAL(COL5) + NVAL(COL6))- NVAL(COL7) - NVAL(COL8) )/NOZERO(T1.COL2)*1000/12/NOZERO(T2.COL14)* 100,1) AS COL16
