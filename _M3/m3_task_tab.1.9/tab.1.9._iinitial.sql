SELECT
  ...
  '0' AS NR_SECTIE2,
  '0' AS NUME_SECTIE2,
   CAEM2||'~'||CUIIO||'_'||FILIAL/0.13 AS NR_ROW,
   ROWNUM AS ORDINE,
  '00000000100001111111000' AS DECIMAL_POS,
   DENUMIRE AS NUME_ROW, 
    ...
    ROUND(COL13,0) AS COL20,
    ROUND(COL14,0) AS COL21,
    ROUND(COL15,0) AS COL22,
    ROUND(COL16,1) AS COL23
FROM
(
SELECT 
  CR.CODUL AS CAEM2,
  ...
  SUM(CASE WHEN RIND='5' THEN VAL ELSE NULL END) COL16
FROM
(
-------------------------------------------------------------------------------
SELECT DISTINCT
