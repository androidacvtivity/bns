...
--            NVAL(CASE WHEN CAPITOL IN (303) AND COL=5 THEN VAL ELSE NULL END) ) AS COL1,
  ...
  SUM(NVAL(CASE WHEN CAPITOL IN (303) AND COL=1 THEN VAL ELSE NULL END) ) AS COL1,
    SUM(CASE WHEN CAPITOL IN (303) AND COL=2 THEN VAL ELSE NULL END) AS COL2,
    SUM(CASE WHEN CAPITOL IN (303) AND COL=3 THEN VAL ELSE NULL END) AS COL3,
    SUM(CASE WHEN CAPITOL IN (303) AND COL=4 THEN VAL ELSE NULL END) AS COL4,
    SUM(CASE WHEN CAPITOL IN (303) AND COL=5 THEN VAL ELSE NULL END) AS COL5,
    SUM(CASE WHEN CAPITOL IN (303) AND COL=6 THEN VAL ELSE NULL END) AS COL6,
    SUM(CASE WHEN CAPITOL IN (303) AND COL=7 THEN VAL ELSE NULL END) AS COL7,
    SUM(CASE WHEN CAPITOL IN (303) AND COL=8 THEN VAL ELSE NULL END) AS COL8,
    SUM(CASE WHEN CAPITOL IN (303) AND COL=9 THEN VAL ELSE NULL END) AS COL9,
    SUM(CASE WHEN CAPITOL IN (303) AND COL=10 THEN VAL ELSE NULL END) AS COL10,
    SUM(CASE WHEN CAPITOL IN (301) AND COL=2 THEN VAL ELSE NULL END) AS COL11
FROM
(
-------------------------------------------------------------------------------
SELECT DISTINCT
...
WHERE 
  D.CAEM2 <> '0' AND 
--  FILIAL = '0' AND 
  (RIND LIKE '%F')  AND D.CUATM_FULL LIKE '%'||:pCOD_CUATM||';%' AND
...
LEFT JOIN (SELECT NR_ROW, COL9, ID_MDTABLE FROM TABLE_OUT  
  ...
  WHERE  ID_MDTABLE =(CASE WHEN :pPERIOADA>=2002 THEN 5673 ELSE NULL END) AND
    FORM IN (3)              AND 
 ...
 SELECT NR_ROW, COL18, ID_MDTABLE FROM TABLE_OUT  
  ...
  WHERE  
    ID_MDTABLE=(CASE WHEN :pPERIOADA<=2002 THEN NULL ELSE 5727 END) AND
