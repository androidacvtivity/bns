...
HAVING
   ...
   ROUND(((SUM(CASE WHEN D.FORM||'.'||D.CAPITOL||'.'||D.RIND IN ('7.40.160') AND D.PERIOADA IN (:PERIOADA) THEN D.COL1 ELSE 0 END)*100)/
                  ...
                  CIS.NOZERO(SUM(CASE WHEN D.FORM||'.'||D.CAPITOL||'.'||D.RIND IN ('7.40.10') AND D.PERIOADA IN (:PERIOADA)  THEN D.COL1 ELSE 0 END)))/
   
     CIS.NOZERO((SUM(CASE WHEN D.FORM||'.'||D.CAPITOL||'.'||D.RIND IN ('7.40.160') AND D.PERIOADA IN (:PERIOADA-12) THEN D.COL1 ELSE 0 END))/
   
                 CIS.NOZERO(SUM(CASE WHEN D.FORM||'.'||D.CAPITOL||'.'||D.RIND IN ('7.40.10') AND D.PERIOADA IN (:PERIOADA-12)  THEN D.COL1 ELSE 0 END))),1)  <100
   ...
   ROUND(((SUM(CASE WHEN D.FORM||'.'||D.CAPITOL||'.'||D.RIND IN ('7.40.160') AND D.PERIOADA IN (:PERIOADA) THEN D.COL1 ELSE 0 END)*100)/
     ...
     CIS.NOZERO((SUM(CASE WHEN D.FORM||'.'||D.CAPITOL||'.'||D.RIND IN ('7.40.160') AND D.PERIOADA IN (:PERIOADA-12) THEN D.COL1 ELSE 0 END))/
                 ...
                 CIS.NOZERO(SUM(CASE WHEN D.FORM||'.'||D.CAPITOL||'.'||D.RIND IN ('7.40.10') AND D.PERIOADA IN (:PERIOADA-12)  THEN D.COL1 ELSE 0 END))),1)>160
