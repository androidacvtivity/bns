...
SELECT
  ...
  NULL COL5, 
   NULL COL6,
   NULL COL7,
  SUM(CASE WHEN C.FULL_CODE LIKE '%'||CTM.CS_CAEM2||'%' THEN D.COL1  ELSE NULL END) AS COL8
...
SELECT
  ...
  NULL COL5, 
   NULL COL6,
  SUM(CASE WHEN C.FULL_CODE LIKE '%'||CTM.CS_CAEM2||'%' THEN D.COL1  ELSE NULL END) AS COL7,
  NULL COL8
...
SELECT
  ...
  NULL COL4, 
  NULL COL5, 
  SUM(CASE WHEN C.FULL_CODE LIKE '%'||CTM.CS_CAEM2||'%' THEN D.COL1  ELSE NULL END) AS COL6,
  NULL COL7,
  NULL COL8
...
SELECT
  ...
  NULL COL3,
  NULL COL4, 
  SUM(CASE WHEN C.FULL_CODE LIKE '%'||CTM.CS_CAEM2||'%' THEN D.COL1  ELSE NULL END) AS COL5,
  NULL COL6,
  NULL COL7,
  NULL COL8  
...
SELECT
  ...
  NULL AS COL2,
  NULL AS COL3,
  SUM(CASE WHEN C.FULL_CODE LIKE '%'||CTM.CS_CAEM2||'%' THEN D.COL1  ELSE NULL END) AS COL4,
  NULL AS COL5,
  NULL AS COL6,
  NULL COL7,
  NULL COL8  
