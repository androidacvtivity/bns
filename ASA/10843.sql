...
--         
  ...
  ROUND(SUM( CASE WHEN (D.PERS BETWEEN RR.PERS_FROM AND RR.PERS_TO OR D.PERS IS NULL )  THEN ROUND(DECODE(R.NR_ROW, 
         ...
         '02',(CASE WHEN D.COL1 BETWEEN 0 AND 3  AND  D.CFP IN ('20') THEN D.CD END),
         '03',(CASE WHEN D.COL1 BETWEEN 3 AND 6  AND  D.CFP IN ('20') THEN D.CD END),
         '04',(CASE WHEN D.COL1 BETWEEN 6 AND 9  AND  D.CFP IN ('20') THEN D.CD END),
         '05',(CASE WHEN D.COL1 BETWEEN 9 AND 12 AND  D.CFP IN ('20') THEN D.CD END),
         '06',(CASE WHEN D.COL2 >0  AND  D.CFP IN ('20') THEN D.CD END),
         '07',(CASE WHEN D.COL3 >0  AND  D.CFP IN ('20') THEN D.CD END),
         '08',(CASE WHEN D.COL4 >0  AND  D.CFP IN ('20') THEN D.CD END)),2) END),0)
  ELSE
  ROUND(SUM( CASE WHEN (D.PERS BETWEEN RR.PERS_FROM AND RR.PERS_TO)  THEN ROUND(DECODE(R.NR_ROW, 
         '01',(CASE WHEN D.CFP IN ('20') THEN D.CD END),
         '02',(CASE WHEN D.COL1 BETWEEN 0 AND 3  AND  D.CFP IN ('20') THEN D.CD END),
         ...
         '06',(CASE WHEN D.COL2 >0  AND  D.CFP IN ('20') THEN D.CD END),
         '07',(CASE WHEN D.COL3 >0  AND  D.CFP IN ('20') THEN D.CD END),
         '08',(CASE WHEN D.COL4 >0  AND  D.CFP IN ('20') THEN D.CD END)),2) END),0) END AS COL4,
...
--CC.CLMN,
 ...
 SUM(CASE WHEN (DD.COL4 BETWEEN RR.PERS_FROM AND RR.PERS_TO OR DD.COL4 = RR.PERS)  THEN ROUND
             (CASE WHEN  D.CAPITOL IN (1124, 1125)  THEN DECODE(CC.NR_COLUMN, '1', D.COL1) 
                   ...
                   WHEN  D.CAPITOL IN (1128)              THEN DECODE(CC.NR_COLUMN, '1', D.COL8, '2', D.COL9, '3', D.COL10) END,11) END)  AS COL1,

 SUM(CASE WHEN (DD.COL4 BETWEEN RR.PERS_FROM AND RR.PERS_TO OR DD.COL4 = RR.PERS)  AND D.CFP IN ('11','12','13') THEN ROUND
             (CASE WHEN  D.CAPITOL IN (1124, 1125) THEN DECODE(CC.NR_COLUMN, '1', D.COL1) 
                   WHEN  D.CAPITOL IN (1126)              THEN DECODE(CC.NR_COLUMN, '1', D.COL1, '2', D.COL2)
                   WHEN  D.CAPITOL IN (1127)              THEN DECODE(CC.NR_COLUMN, '1', D.COL3, '2', D.COL4, '3', D.COL5)
                   WHEN  D.CAPITOL IN (1128)              THEN DECODE(CC.NR_COLUMN, '1', D.COL8, '2', D.COL9, '3', D.COL10) END,11) END)  AS COL2,
                   
                                                                                                        
 SUM(CASE WHEN (DD.COL4 BETWEEN RR.PERS_FROM AND RR.PERS_TO OR DD.COL4 = RR.PERS) AND  D.CFP IN ('14','15','16','17','18','19') THEN ROUND
             (CASE WHEN  D.CAPITOL IN (1124, 1125)  THEN DECODE(CC.NR_COLUMN, '1', D.COL1) 
                   WHEN  D.CAPITOL IN (1126)              THEN DECODE(CC.NR_COLUMN, '1', D.COL1, '2', D.COL2)
                   WHEN  D.CAPITOL IN (1127)              THEN DECODE(CC.NR_COLUMN, '1', D.COL3, '2', D.COL4, '3', D.COL5)
                   WHEN  D.CAPITOL IN (1128)              THEN DECODE(CC.NR_COLUMN, '1', D.COL8, '2', D.COL9, '3', D.COL10) END,11) END)  AS COL3,
                   
                                                                                                                           
 SUM(CASE WHEN (DD.COL4 BETWEEN RR.PERS_FROM AND RR.PERS_TO OR DD.COL4 = RR.PERS) AND  D.CFP IN ('20') THEN ROUND
             (CASE WHEN  D.CAPITOL IN (1124, 1125)  THEN DECODE(CC.NR_COLUMN, '1', D.COL1) 
                   WHEN  D.CAPITOL IN (1126)              THEN DECODE(CC.NR_COLUMN, '1', D.COL1, '2', D.COL2)
                   WHEN  D.CAPITOL IN (1127)              THEN DECODE(CC.NR_COLUMN, '1', D.COL3, '2', D.COL4, '3', D.COL5)
                   WHEN  D.CAPITOL IN (1128)              THEN DECODE(CC.NR_COLUMN, '1', D.COL8, '2', D.COL9, '3', D.COL10) END,11) END)  AS COL4,                   
                   
                                                                                                        
 SUM(CASE WHEN (DD.COL4 BETWEEN RR.PERS_FROM AND RR.PERS_TO OR DD.COL4 = RR.PERS) AND  D.CFP IN ('22','23','24','25','26','27') THEN ROUND
             (CASE WHEN  D.CAPITOL IN (1124, 1125)  THEN DECODE(CC.NR_COLUMN, '1', D.COL1)
                   WHEN  D.CAPITOL IN (1126)              THEN DECODE(CC.NR_COLUMN, '1', D.COL1, '2', D.COL2) 
                   WHEN  D.CAPITOL IN (1127)              THEN DECODE(CC.NR_COLUMN, '1', D.COL3, '2', D.COL4, '3', D.COL5)
                   WHEN  D.CAPITOL IN (1128)              THEN DECODE(CC.NR_COLUMN, '1', D.COL8, '2', D.COL9, '3', D.COL10) END,11) END)  AS COL5,                   
                    
                                                                                                        
 SUM(CASE WHEN (DD.COL4 BETWEEN RR.PERS_FROM AND RR.PERS_TO OR DD.COL4 = RR.PERS) AND  D.CFP IN ('28') THEN ROUND
             (CASE WHEN  D.CAPITOL IN (1124, 1125)  THEN DECODE(CC.NR_COLUMN, '1', D.COL1) 
                   WHEN  D.CAPITOL IN (1126)              THEN DECODE(CC.NR_COLUMN, '1', D.COL1, '2', D.COL2)
                   WHEN  D.CAPITOL IN (1127)              THEN DECODE(CC.NR_COLUMN, '1', D.COL3, '2', D.COL4, '3', D.COL5)
                   WHEN  D.CAPITOL IN (1128)              THEN DECODE(CC.NR_COLUMN, '1', D.COL8, '2', D.COL9, '3', D.COL10) END,11) END)  AS COL6
