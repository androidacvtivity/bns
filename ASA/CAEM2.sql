...
(
SELECT 
DISTINCT D.CUIIO,D. CUATM, CASE WHEN D.CAEM2_ACTUALIZAT IS NULL THEN D.CAEM2 ELSE D.CAEM2_ACTUALIZAT END AS CAEM2,
D.COL1, D.COL2, D.COL3, D.COL4,D.PERS, D.CD
 FROM
...
-- INNER JOIN CIS2.VW_CL_CAEM2 C ON SUBSTR( C.CODUL,2,4)  = D.CAEM2
