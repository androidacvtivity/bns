...
CASE WHEN NR_ROW IN ('02','04','06','08','10') THEN 100  ELSE COL1 END AS COL1,
CASE WHEN NR_ROW IN ('02','04','06','08','10') THEN 100  ELSE COL2 END AS COL2 
...
SELECT 
 ...
 --C.FULL_CODE LIKE '%'||CC.CODUL||';%' 
 THEN ROUND (DECODE(RR.NR_ROW, 
         '01', (DD.COL0),
         '02', '100',
         '03',(DD.COL1),
         '04', '100',
