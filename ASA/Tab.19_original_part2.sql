DECLARE
  ...
  CURSOR UPD_TABLE_OUT IS
    SELECT 
      SUBSTR(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(T.NR_ROW,'01','02'),'03','04'),'05','06'),'07','08'),'09','10'),0,8) AS NR_ROW,
--      LAG(T.NR_ROW, 1, 0) OVER (ORDER BY T.NR_ROW) AS PREV_ROW,
      T.COL1 AS COL1,
      T.COL2 AS COL2,
      T.COL3 AS COL3,
      T.COL4 AS COL4,
